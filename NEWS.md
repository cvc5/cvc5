...
- API: Sort, Term, Op and datatype objects do not maintain a reference
       (and depend) on Solver anymore. Instead, they are now associated
       to a NodeManager object. This allows sharing of NodeManagers between
       solver instances.
