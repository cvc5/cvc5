...
- Add a `--safe` build configuration where only standard (non-expert) features
  of cvc5 can be used. In particular, this build configuration enables
  `--safe-options` by default. For details see `./configure.sh --help`.
