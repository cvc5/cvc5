...
enum ENUM(Kind)
{
   ...
   *
   *   - TermManager::mkTerm(Kind, const std::vector<Term>&) const
   *   - TermManager::mkTerm(const Op&, const std::vector<Term>&) const
   *
   * - Create Op of this kind with:
   *
   *   - TermManager::mkOp(Kind, const std::vector<uint32_t>&) const
   */
  EVALUE(EQUAL),
  /**
   * Disequality.
   ...
   * - Create Term of this Kind with:
   *
   *   - TermManager::mkConst(const Sort&, const std::string&) const
   *   - TermManager::mkConst(const Sort&) const
   *
   * \rst
   * .. note::
   *
   ...
   * - Create Term of this Kind with:
   *
   *   - TermManager::mkVar(const Sort&, const std::string&) const
   *
   * \rst
   ...
   * - Create Term of this Kind with:
   *
   *   - TermManager::mkTrue() const
   *   - TermManager::mkFalse() const
   *   - TermManager::mkBoolean(bool) const
   */
   ...
   * - Create Term of this Kind with:
   *
   *   - TermManager::mkCardinalityConstraint(const Sort&, uint32_t) const
   *
   * \rst
   * .. warning:
   *
   ...
   * - Create Term of this Kind with:
   *
   *   - TermManager::mkReal(const std::string&) const
   *   - TermManager::mkReal(int64_t) const
   *   - TermManager::mkReal(int64_t, int64_t) const
   */
   ...
   * - Create Term of this Kind with:
   *
   *   - TermManager::mkInteger(const std::string&) const
   *   - TermManager::mkInteger(int64_t) const
   */
   ...
   * - Create Term of this Kind with:
   *
   *   - TermManager::mkBitVector(uint32_t, uint64_t) const
   *   - TermManager::mkBitVector(uint32_t, const std::string&, uint32_t) const
   */
   ...
   * - Create Term of this Kind with:
   *
   *   - TermManager::mkFiniteFieldElem(const std::string&, const Sort&, uint32_t base) const
   */
   ...
   * - Create Term of this Kind with:
   *
   *   - TermManager::mkFloatingPoint(uint32_t, uint32_t, Term) const
   */
   ...
   * - Create Term of this Kind with:
   *
   *   - TermManager::mkRoundingMode(RoundingMode) const
   */
   ...
   *
   * - Create Term of this Kind with:
   *   - TermManager::mkNullableLift(Kind, const std::vector<Term>&) const
   *   - TermManager::mkTerm(Kind, const std::vector<Term>&) const
  */
   ...
   * - Create Term of this Kind with:
   *
   *   - TermManager::mkSepNil(const Sort&) const
   *
   * \rst
   * .. warning::
   *
   ...
   * - Create Term of this Kind with:
   *
   *   - TermManager::mkEmptySet(const Sort&) const
   */
  EVALUE(SET_EMPTY),
  /**
   * Set union.
   ...
   * - Create Term of this Kind with:
   *
   *   - TermManager::mkUniverseSet(const Sort&) const
   *
   * \rst
   * .. note::
   *
   ...
   * - Create Term of this Kind with:
   *
   *   - TermManager::mkEmptyBag(const Sort&) const
   */
  EVALUE(BAG_EMPTY),
  /**
   * Bag max union.
   ...
   * - Create Term of this Kind with:
   *
   *   - TermManager::mkTerm(Kind, const Term&, const Term&) const
   *   - TermManager::mkTerm(Kind, const std::vector<Term>&) const
   */
  EVALUE(BAG_COUNT),
  /**
  ...
  */
   ...
   * - Create Term of this Kind with:
   *
   *   - TermManager::mkString(const std::string&, bool) const
   *   - TermManager::mkString(const std::wstring&) const
   */
  EVALUE(CONST_STRING),
  /**
   ...
   * - Create Term of this Kind with:
   *
   *   - TermManager::mkRegexpNone() const
   */
  EVALUE(REGEXP_NONE),
  /**
   ...
   * - Create Term of this Kind with:
   *
   *   - TermManager::mkRegexpAllchar() const
   */
   ...
   * - Create Term of this Kind with:
   *
   *   - TermManager::mkEmptySequence(const Sort&) const
   */
...
enum ENUM(SortKind)
{
   ...
   *
   *   - TermManager::mkAbstractSort(SortKind) const
   */
   ...
   * - Create Sort of this Kind with:
   *
   *   - TermManager::mkArraySort(Sort, Sort) const
   */
  EVALUE(ARRAY_SORT),
  /**
   ...
   * - Create Sort of this Kind with:
   *
   *   - TermManager::mkBagSort(Sort) const
   */
  EVALUE(BAG_SORT),
  /**
   * The Boolean sort.
   ...
   * - Create Sort of this Kind with:
   *
   *   - TermManager::getBooleanSort() const
   */
  EVALUE(BOOLEAN_SORT),
  /**
   ...
   * - Create Sort of this Kind with:
   *
   *   - TermManager::mkBitVectorSort(uint32_t) const
   */
   ...
   * - Create Sort of this Kind with:
   *
   *   - TermManager::mkFiniteFieldSort(const std::string&, uint32_t base) const
   */
   ...
   * - Create Sort of this Kind with:
   *
   *   - TermManager::mkFloatingPointSort(uint32_t, uint32_t) const
   */
   ...
   * - Create Sort of this Kind with:
   *
   *   - TermManager::mkFunctionSort(const std::vector<Sort>&, Sort) const
   */
   ...
   * - Create Sort of this Kind with:
   *
   *   - TermManager::getIntegerSort() const
   */
  EVALUE(INTEGER_SORT),
  /**
   * The real sort.
   ...
   * - Create Sort of this Kind with:
   *
   *   - TermManager::getRegExpSort() const
   */
  EVALUE(REGLAN_SORT),
  /**
   ...
   * - Create Sort of this Kind with:
   *
   *   - TermManager::getRoundingModeSort() const
   */
   ...
   * - Create Sort of this Kind with:
   *
   *   - TermManager::mkSequenceSort(Sort) const
   */
   ...
   * - Create Sort of this Kind with:
   *
   *   - TermManager::mkSetSort(Sort) const
   */
  EVALUE(SET_SORT),
  /**
   * The string sort.
   ...
   * - Create Sort of this Kind with:
   *
   *   - TermManager::getStringSort() const
   */
  EVALUE(STRING_SORT),
  /**
   ...
   * - Create Sort of this Kind with:
   *
   *   - TermManager::mkTupleSort(const std::vector<Sort>&) const
   */
  EVALUE(TUPLE_SORT),
  /**
   ...
   * - Create Sort of this Kind with:
   *
   *   - TermManager::mkNullableSort(const Sort&) const
   */
   ...
   * - Create Sort of this Kind with:
   *
   *   - TermManager::mkUninterpretedSort(const std::optional<std::string>&) const
   */
