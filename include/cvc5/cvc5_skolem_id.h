...
enum ENUM(SkolemId)
{
 ...
 /**
  ...
  /**
   * The bag integer skolem, which denotes the cardinality of a bag term in
   * liastar. It is the slot of that bag in the outer vector of the star atom
   * generated by the translation of bag constraints to liastar.
   *
   * - Number of skolem indices: ``1``
   *   - ``1:`` The bag of type ``(Bag T)``.
   * - Sort: ``Int``
   */
  EVALUE(BAGS_LIASTAR_BAG_INTEGER),
  /**
