...
bool ParserState::getTesterName(cvc5::Term cons, std::string& name) { return false; }
...
cvc5::Term ParserState::bindBoundVar(const std::string& name, const cvc5::Sort& type)
{
