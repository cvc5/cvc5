 ...
 * @return the parsed expression, or the Null cvc5::internal::api::Term if we've reached
 * the end of the input
 */
parseExpr returns [cvc5::internal::parser::tptp::myExpr expr]
  : cnfFormula[expr]
  | EOF
  ;
 ...
 */
parseCommand returns [cvc5::internal::Command* cmd = NULL]
@declarations {
  cvc5::internal::api::Term expr;
  Tptp::FormulaRole fr;
  ...
  { PARSER_STATE->popScope();
    ...
    {
      cvc5::internal::api::Term aexpr = PARSER_STATE->getAssertionExpr(fr, expr);
      if( !aexpr.isNull() ){
  ...
  | EOF
    {
      ...
      cvc5::internal::api::Term aexpr = PARSER_STATE->getAssertionDistinctConstants();
      if( !aexpr.isNull() )
      {
...
formulaRole[cvc5::internal::parser::Tptp::FormulaRole& role]
  : LOWER_WORD
    {
...
cnfFormula[cvc5::internal::api::Term& expr]
  : LPAREN_TOK cnfDisjunction[expr] RPAREN_TOK
  | cnfDisjunction[expr]
;

cnfDisjunction[cvc5::internal::api::Term& expr]
@declarations {
...
cnfLiteral[cvc5::internal::api::Term& expr]
  : atomicFormula[expr]
  | NOT_TOK atomicFormula[expr] { expr = MK_TERM(api::NOT, expr); }
  ;

atomicFormula[cvc5::internal::api::Term& expr]
@declarations {
  cvc5::internal::api::Term expr2;
  std::string name;
  std::vector<cvc5::internal::api::Term> args;
  bool equal;
  ParseOp p;
}
...
thfAtomicFormula[cvc5::internal::ParseOp& p]
@declarations {
  cvc5::internal::api::Term expr2;
  std::string name;
  std::vector<cvc5::internal::api::Term> args;
...
definedProp[cvc5::internal::api::Term& expr]
  : TRUE_TOK { expr = SOLVER->mkTrue(); }
  | FALSE_TOK  { expr = SOLVER->mkFalse(); }
  ;

definedPred[cvc5::internal::ParseOp& p]
  : '$less'
    {
      p.d_kind = api::LT;
    }
...
thfDefinedPred[cvc5::internal::ParseOp& p]
  : '$less'
     {
       p.d_kind = api::LT;
     }
...
definedFun[cvc5::internal::ParseOp& p]
@declarations {
...
term[cvc5::internal::api::Term& expr]
  : functionTerm[expr]
...
letTerm[cvc5::internal::api::Term& expr]
@declarations {
  cvc5::internal::api::Term lhs, rhs;
}
...
/* Not an application */
simpleTerm[cvc5::internal::api::Term& expr]
  : variable[expr]
...
/* Not an application */
thfSimpleTerm[cvc5::internal::api::Term& expr]
  : NUMBER { expr = PARSER_STATE->d_tmp_expr; }
  | DISTINCT_OBJECT
    {
...
functionTerm[cvc5::internal::api::Term& expr]
@declarations {
  std::vector<cvc5::internal::api::Term> args;
  ParseOp p;
}
...
conditionalTerm[cvc5::internal::api::Term& expr]
@declarations {
  cvc5::internal::api::Term expr2, expr3;
}
...
plainTerm[cvc5::internal::api::Term& expr]
@declarations {
  std::string name;
  std::vector<api::Term> args;
  ParseOp p;
...
arguments[std::vector<cvc5::internal::api::Term>& args]
@declarations {
  cvc5::internal::api::Term expr;
}
  :
...
variable[cvc5::internal::api::Term& expr]
  : UPPER_WORD
    {
...
/*******/
/* FOF */
fofFormula[cvc5::internal::api::Term& expr] : fofLogicFormula[expr] ;

fofLogicFormula[cvc5::internal::api::Term& expr]
@declarations {
  tptp::NonAssoc na;
  std::vector< cvc5::internal::api::Term > args;
  cvc5::internal::api::Term expr2;
...
fofUnitaryFormula[cvc5::internal::api::Term& expr]
@declarations {
  api::Kind kind;
  std::vector< cvc5::internal::api::Term > bv;
}
  : atomicFormula[expr]
...
bindvariable[cvc5::internal::api::Term& expr]
  : UPPER_WORD
    { std::string name = AntlrInput::tokenText($UPPER_WORD);
      expr = PARSER_STATE->bindBoundVar(name, PARSER_STATE->d_unsorted);
    }
...
fofBinaryNonAssoc[cvc5::internal::parser::tptp::NonAssoc& na]
...
folQuantifier[cvc5::internal::api::Kind& kind]
...
thfQuantifier[cvc5::internal::api::Kind& kind]
  : FORALL_TOK { kind = api::FORALL; }
  | EXISTS_TOK { kind = api::EXISTS; }
...
thfAtomTyping[cvc5::internal::Command*& cmd]
// for now only supports mapping types (i.e. no applied types)
@declarations {
  cvc5::internal::api::Term expr;
  cvc5::internal::api::Sort type;
  std::string name;
}
    ...
    | parseThfType[type]
      {
        ...
        else
        {
          ...
          cvc5::internal::api::Term freshExpr;
          if (type.isFunction())
          {
...
thfLogicFormula[cvc5::internal::ParseOp& p]
@declarations {
  tptp::NonAssoc na;
  std::vector<cvc5::internal::api::Term> args;
...
thfTupleForm[std::vector<cvc5::internal::api::Term>& args]
@declarations {
  ParseOp p;
}
  : thfUnitaryFormula[p]
...
thfUnitaryFormula[cvc5::internal::ParseOp& p]
@declarations {
  api::Kind kind;
  std::vector< cvc5::internal::api::Term > bv;
  cvc5::internal::api::Term expr;
...
/*******/
/* TFF */
tffFormula[cvc5::internal::api::Term& expr] : tffLogicFormula[expr];

tffTypedAtom[cvc5::internal::Command*& cmd]
@declarations {
  cvc5::internal::api::Term expr;
  cvc5::internal::api::Sort type;
  std::string name;
  ...
  | nameN[name] COLON_TOK
    ...
    | parseType[type]
      { if(PARSER_STATE->isDeclared(name, SYM_SORT)) {
          ...
          // as yet, it's undeclared
          cvc5::internal::api::Term aexpr = PARSER_STATE->bindVar(name, type);
...
tffLogicFormula[cvc5::internal::api::Term& expr]
@declarations {
  tptp::NonAssoc na;
  std::vector< cvc5::internal::api::Term > args;
  cvc5::internal::api::Term expr2;
...
tffUnitaryFormula[cvc5::internal::api::Term& expr]
@declarations {
  api::Kind kind;
  std::vector< cvc5::internal::api::Term > bv;
  cvc5::internal::api::Term lhs, rhs;
...
tffLetTermDefn[cvc5::internal::api::Term& lhs, cvc5::internal::api::Term& rhs]
@declarations {
  std::vector<cvc5::internal::api::Term> bvlist;
}
  : (FORALL_TOK LBRACK_TOK tffVariableList[bvlist] RBRACK_TOK COLON_TOK)*
    tffLetTermBinding[bvlist, lhs, rhs]
  ;

tffLetTermBinding[std::vector<cvc5::internal::api::Term> & bvlist,
                  cvc5::internal::api::Term& lhs,
                  cvc5::internal::api::Term& rhs]
...
tffLetFormulaDefn[cvc5::internal::api::Term& lhs, cvc5::internal::api::Term& rhs]
@declarations {
  std::vector<cvc5::internal::api::Term> bvlist;
}
  : (FORALL_TOK LBRACK_TOK tffVariableList[bvlist] RBRACK_TOK COLON_TOK)*
...
tffLetFormulaBinding[std::vector<cvc5::internal::api::Term> & bvlist,
                     cvc5::internal::api::Term& lhs,
                     cvc5::internal::api::Term& rhs]
...
thfBindVariable[cvc5::internal::api::Term& expr]
@declarations {
  std::string name;
  cvc5::internal::api::Sort type = PARSER_STATE->d_unsorted;
}
  : UPPER_WORD
...
tffbindvariable[cvc5::internal::api::Term& expr]
@declarations {
  cvc5::internal::api::Sort type = PARSER_STATE->d_unsorted;
}
  : UPPER_WORD
...
tffVariableList[std::vector<cvc5::internal::api::Term>& bvlist]
@declarations {
  cvc5::internal::api::Term e;
}
  : tffbindvariable[e] { bvlist.push_back(e); }
    ( COMMA_TOK tffbindvariable[e] { bvlist.push_back(e); } )*
  ;

parseThfType[cvc5::internal::api::Sort& type]
// assumes only mapping types (arrows), no tuple type
@declarations {
  std::vector<cvc5::internal::api::Sort> sorts;
}
...
thfType[cvc5::internal::api::Sort& type]
// assumes only mapping types (arrows), no tuple type
  : simpleType[type]
...
parseType[cvc5::internal::api::Sort & type]
@declarations
{
  std::vector<cvc5::internal::api::Sort> v;
}
  : simpleType[type]
...
// non-function types
simpleType[cvc5::internal::api::Sort& type]
@declarations {
  std::string name;
}
  : DEFINED_SYMBOL
