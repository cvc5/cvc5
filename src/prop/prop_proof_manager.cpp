    ...
    modes::ProofComponent pc)
{
  ...
  Assert(pc == modes::ProofComponent::PROOF_COMPONENT_THEORY_LEMMAS
         || pc == modes::ProofComponent::PROOF_COMPONENT_PREPROCESS);
  std::vector<std::shared_ptr<ProofNode>> pfs =
      pc == modes::ProofComponent::PROOF_COMPONENT_THEORY_LEMMAS
