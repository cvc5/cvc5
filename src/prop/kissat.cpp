...
KissatSolver::Statistics::Statistics(StatisticsRegistry* registry,
    ...
    : d_registry(registry),
      d_numSatCalls(prefix + "Kissat::calls_to_solve", 0),
      d_numVariables(prefix + "Kissat::variables", 0),
      d_numClauses(prefix + "Kissat::clauses", 0),
      d_solveTime(prefix + "Kissat::solve_time")
{
