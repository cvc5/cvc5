...
class RewriteDb
{
 ...
 private:
  ...
  std::map<RewriteRuleId, RewriteProofRule> d_rewDbRule;
  /** map conclusions to proof ids */
  std::map<Node, std::vector<RewriteRuleId> > d_concToRules;
  /** map head to proof ids */
  std::map<Node, std::vector<RewriteRuleId> > d_headToRules;
  /** dummy empty vector */
  std::vector<RewriteRuleId> d_emptyVec;
