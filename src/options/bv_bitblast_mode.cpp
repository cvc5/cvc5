...
std::ostream& operator<<(std::ostream& out, theory::bv::BvProofFormat format) {
  switch(format) {
  case theory::bv::BITVECTOR_PROOF_ER:
    out << "BITVECTOR_PROOF_ER";
    break;
  case theory::bv::BITVECTOR_PROOF_DRAT:
    out << "BITVECTOR_PROOF_DRAT";
    break;
  case theory::bv::BITVECTOR_PROOF_LRAT:
    out << "BITVECTOR_PROOF_LRAT";
    break;
  default:
    out << "BvProofFormat:UNKNOWN![" << unsigned(format) << "]";
  }
