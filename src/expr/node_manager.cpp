...
NodeManager::mkPredicateType(const std::vector<TypeNode>& sorts) {
 ...
 TypeNode NodeManager::mkFunctionType(const TypeNode& domain, const TypeNode& range) {
 ...
 TypeNode NodeManager::mkFunctionType(const std::vector<TypeNode>& argTypes, const TypeNode& range) {
