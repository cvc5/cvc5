...
enum class BoundVarId
{
  ...
  BAGS_SECOND_INDEX,
  /**
   * A bound variable that denotes the count of a bag at the single unnamed
   * element described by the body of the star atom generated by the
   * translation of bag constraints to liastar. There is one such variable per
   * bag term, and it is the slot of that bag in the body.
   */
  BAGS_LIASTAR_BAG_COUNT,
  /**
   * A bound variable corresponding to the universally quantified integer
