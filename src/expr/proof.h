...
class CDProof
{
 public:
   ...
   * objects may be generated by this call, and further modifications to pn does
   * not impact the internal data of this class.
   */
  bool addProof(std::shared_ptr<ProofNode> pn, bool forceOverwrite = false, bool doCopy = false);
