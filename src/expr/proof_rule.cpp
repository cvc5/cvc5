...
const char* toString(PfRule id)
{
  switch (id)
  {
    ...
    case PfRule::ARITH_TRANS_SINE_APPROX_ABOVE_NEG: return "ARITH_TRANS_SINE_APPROX_ABOVE_NEG";
    ...
    case PfRule::ARITH_TRANS_SINE_APPROX_BELOW_POS: return "ARITH_TRANS_SINE_APPROX_BELOW_POS";
