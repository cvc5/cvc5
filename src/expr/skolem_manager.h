 ...
 * (2) a predicate they satisfy (solely used by mkSkolemize),
 ...
 *
 * If a variable is not associated with any of the above information,
 ...
 * body is a predicate they satisfy. This is used in mkSkolem below.
 *
