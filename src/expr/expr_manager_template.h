...
public:
  ...
  DatatypeType mkDatatypeType(Datatype& datatype, uint32_t flags = DATATYPE_FLAG_NONE);

  /**
   * Make a set of types representing the given datatypes, which may be
   * mutually recursive.
   */
  std::vector<DatatypeType> mkMutualDatatypeTypes(std::vector<Datatype>& datatypes, uint32_t flags = DATATYPE_FLAG_NONE);
   ...
   */
  std::vector<DatatypeType> mkMutualDatatypeTypes(std::vector<Datatype>& datatypes, std::set<Type>& unresolvedTypes, uint32_t flags = DATATYPE_FLAG_NONE);
