...
void TptpPrinter::toStream(std::ostream& out, TNode n, int toDepth, bool types,
                           size_t dag) const {
  n.toStream(out, toDepth, types, dag, language::output::LANG_SMTLIB_V2_5);
}/* TptpPrinter::toStream() */

void TptpPrinter::toStream(std::ostream& out, const Command* c, int toDepth,
...
void TptpPrinter::toStream(std::ostream& out, const Model& m,
