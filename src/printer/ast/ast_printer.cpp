...
void AstPrinter::toStream(std::ostream& out, TNode n, int toDepth, bool types,
                          size_t dag) const {
  if(dag != 0) {
...
void AstPrinter::toStream(std::ostream& out, const Command* c, int toDepth,
...
void AstPrinter::toStream(std::ostream& out, const Model& m,
