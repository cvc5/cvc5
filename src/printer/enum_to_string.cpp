...
const char* toString(cvc5::SkolemId id)
{
  switch (id)
  {
    ...
    case cvc5::SkolemId::ARITH_VTS_DELTA:
      return "arith_vts_delta";
    case cvc5::SkolemId::ARITH_VTS_DELTA_FREE:
      return "arith_vts_delta_free";
    case cvc5::SkolemId::ARITH_VTS_INFINITY:
      return "arith_vts_infinity";
