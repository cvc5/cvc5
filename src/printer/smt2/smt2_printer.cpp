...
static void toStreamRational(std::ostream& out, const Rational& r,
                             bool decimal);

void Smt2Printer::toStream(std::ostream& out, TNode n, int toDepth, bool types,
                           size_t dag) const {
  if(dag != 0) {
...
void Smt2Printer::toStream(std::ostream& out, const Command* c, int toDepth,
...
void Smt2Printer::toStream(std::ostream& out, const Model& m,
