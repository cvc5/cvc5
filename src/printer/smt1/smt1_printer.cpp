...
void Smt1Printer::toStream(std::ostream& out, TNode n, int toDepth, bool types,
                           size_t dag) const {
  n.toStream(out, toDepth, types, dag, language::output::LANG_SMTLIB_V2_5);
}/* Smt1Printer::toStream() */

void Smt1Printer::toStream(std::ostream& out, const Command* c, int toDepth,
                           bool types, size_t dag) const {
...
void Smt1Printer::toStream(std::ostream& out, const Model& m,
