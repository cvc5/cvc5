...
class ModelBlocker
{
 ...
 public:
   ...
   */
  static Expr getModelBlocker(const std::vector<Expr>& assertions, theory::TheoryModel* m, BlockModelsMode mode, const std::vector<Expr>& exprToBlock = std::vector<Expr>());
