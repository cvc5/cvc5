...
void SetDefaults::setDefaultsPre(Options& opts)
{
  ...
  if (d_isInternalSubsolver)
  {
    ...
    SET_AND_NOTIFY(Quantifiers, sygusInference, options::SygusInferenceMode::OFF, "internal subsolver");
                                              ...
                                              std::ostream& suggest) const
{
  ...
  if (opts.quantifiers.sygusInference!=options::SygusInferenceMode::OFF)
  {
    ...
    SET_AND_NOTIFY(Quantifiers, sygusInference, options::SygusInferenceMode::OFF, "incremental solving");
  }
