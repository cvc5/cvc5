 ...
 *
 * - If we are producing unast cores using this proof infrastructure, then the
 *   SmtEngine will have proofs using this proof manager (if --produce-proofs
 *   was not passed by the user it will be activiated), but these proofs will
 ...
 *
 * - If SmtEngine has been configured in a way that is incompatible with unsat
 *   cores, then proofs will be disabled, regardless of --produce-proofs being
 *   given.
 */
class PfManager
{
