...
// Types to support: Integers, Floats, Strings, BV Signed, BV Unsigned

#include "cvc4_private.h"

#ifndef CVC4__SMT__OPT_SOLVER_H
#define CVC4__SMT__OPT_SOLVER_H
...
class Objective
{
 public:
  ...
  /** A getter for d_node **/
  Node getNode();
  /** If the objective type is BitVector, query if it's a signed comparison
   * only valid when the objective type is BitVector! **/
  bool isSigned();
