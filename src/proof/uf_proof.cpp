...
Node ProofUF::toStreamRecLFSC(std::ostream& out, TheoryProof * tp, theory::eq::EqProof * pf, unsigned tb, const LetMap& map) {
  ...
  if(tb == 0) {
    ...
    if (options::eagerUfProofs()) {
      ...
      if (pf->d_node[0].getKind() == kind::NOT ||
        ...
        Debug("pf::uf") << "In eager mode, and proof was generated by explain(). Correcting it..." << std::endl;
        ...
        Debug("pf::uf") << "New proof: " << std::endl;
        pf->debug_print("pf::uf");
        Debug("pf::uf") << std::endl;
      }
    }
  ...
  case theory::eq::MERGED_THROUGH_TRANS: {
    ...
    for(size_t i = 1; i < pf->d_children.size(); ++i) {
      ...
      //  ss << std::endl << "n1 = " << n1 << std::endl << "n2 = " << n2 << std::endl;
