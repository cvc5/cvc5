...
void ResolutionBitVectorProof::startBVConflict(CVC4::BVMinisat::Solver::TCRef cr) {
  d_resolutionProof->startResChain(cr);
}

void ResolutionBitVectorProof::startBVConflict(CVC4::BVMinisat::Solver::TLit lit) {
  d_resolutionProof->startResChain(lit);
}

void ResolutionBitVectorProof::endBVConflict(const CVC4::BVMinisat::Solver::TLitVec& confl) {
  Debug("pf::bv") << "ResolutionBitVectorProof::endBVConflict called" << std::endl;
  ...
  Debug("pf::bv") << "ResolutionBitVectorProof::endBVConflict id" <<clause_id<< " => " << conflict << "\n";
  d_isAssumptionConflict = false;
}
