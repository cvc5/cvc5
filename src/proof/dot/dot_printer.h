...
class DotPrinter
{
 ...
 private:
   ...
   * was generated by the SAT solver and thus belongs to the SAT cluster type
   ...
   * @param scopeCounter counter of how many SCOPE were already depth-first
   * traversed in the proof up to this point
   * @param inPropositionalView flag used to mark whether the proof node being
   * traversed was generated by the SAT solver and thus belong to the
   * propositional view
   */
