...
const char* toString(TrustId id)
{
  switch (id)
  {
    ...
    case TrustId::PREPROCESS_MIPLIB_TRICK:
      return "PREPROCESS_MIPLIB_TRICK";
    case TrustId::PREPROCESS_MIPLIB_TRICK_LEMMA:
      return "PREPROCESS_MIPLIB_TRICK_LEMMA";
    case TrustId::PREPROCESS_NL_EXT_PURIFY:
      return "PREPROCESS_NL_EXT_PURIFY";
    ...
    case TrustId::PREPROCESS_SORT_INFER:
        return "PREPROCESS_SORT_INFER";
