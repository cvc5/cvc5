...
class LfscPrinter
{
 ...
 private:
   ...
   * printed, which ensures that all of its component types, and the user-defined subfields of datatype types among those are declared.
   * This furthermore includes running to a fixed point in the case that tn contains
