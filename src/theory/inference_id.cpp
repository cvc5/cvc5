...
case InferenceId::QUANTIFIERS_SYGUS_CEGIS_UCL_SYM_BREAK: return "QUANTIFIERS_SYGUS_CEGIS_UCL_SYM_BREAK";
case InferenceId::QUANTIFIERS_SYGUS_CEGIS_UCL_EXCLUDE: return "QUANTIFIERS_SYGUS_CEGIS_UCL_EXCLUDE";
case InferenceId::QUANTIFIERS_SYGUS_REPAIR_CONST_EXCLUDE: return "QUANTIFIERS_SYGUS_REPAIR_CONST_EXCLUDE";
case InferenceId::QUANTIFIERS_SYGUS_CEGIS_REFINE: return "QUANTIFIERS_SYGUS_CEGIS_REFINE";
case InferenceId::QUANTIFIERS_SYGUS_CEGIS_REFINE_SAMPLE: return "QUANTIFIERS_SYGUS_CEGIS_REFINE_SAMPLE";
case InferenceId::QUANTIFIERS_SYGUS_REFINE_EVAL: return "QUANTIFIERS_SYGUS_REFINE_EVAL";
case InferenceId::QUANTIFIERS_SYGUS_EVAL_UNFOLD: return "QUANTIFIERS_SYGUS_EVAL_UNFOLD";
case InferenceId::QUANTIFIERS_SYGUS_PBE_EXCLUDE: return "QUANTIFIERS_SYGUS_PBE_EXCLUDE";
case InferenceId::QUANTIFIERS_SYGUS_PBE_CONSTRUCT_SOL: return "QUANTIFIERS_SYGUS_PBE_CONSTRUCT_SOL";
