...
const char* toString(InferenceId i)
{
  switch (i)
  {
    ...
    case InferenceId::STRINGS_ARRAY_NTH_UPDATE_SHORTCUT1:
      return "STRINGS_ARRAY_NTH_UPDATE_SHORTCUT1";
    case InferenceId::STRINGS_ARRAY_NTH_UPDATE_SHORTCUT2:
      return "STRINGS_ARRAY_NTH_UPDATE_SHORTCUT2";
