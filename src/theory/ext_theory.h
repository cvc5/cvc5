...
public:
   ...
   */
  virtual bool getCurrentSubstitution(int effort, const std::vector<Node>& vars,
   ...
   */
  virtual bool isExtfReduced( int effort, Node n, Node on, std::vector< Node >& exp );
...
class ExtTheory
{
 ...
 public:
   ...
   */
  ExtTheory(ExtTheoryCallback& p, context::Context * c, context::UserContext * u, OutputChannel& out, bool cacheEnabled = false);
  virtual ~ExtTheory() {}
