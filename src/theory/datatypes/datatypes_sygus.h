...
private:
 ...
 class SearchCache
 {
   ...
   */
  Node getSimpleSymBreakPred( TypeNode tn, int tindex, unsigned depth, bool usingSymCons );
  /** Cache of the above function */
  std::map<TypeNode, std::map<int, std::map< bool, std::map<unsigned, Node>>>> d_simple_sb_pred;
  /**
