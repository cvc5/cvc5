    ...
    if( !makeConflict ){
      ...
      if( tpolarity ){
        ...
        if (n_lbl == dt.getNumConstructors() - 1)
        {
          ...
          d_im.addPendingFact(t_concl, t_concl_exp);
