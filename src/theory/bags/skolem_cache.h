...
#ifndef CVC4__THEORY__BAGS__SKOLEM_CACHE_H
#define CVC4__THEORY__BAGS__SKOLEM_CACHE_H
...
/**
 * A cache of all bag skolems generated by the TheoryBags class. This
...
class SkolemCache
{
 public:
   ...
   * inference in the bags solver, where by skolem we mean the fresh
   * bag variable that witnesses each of "exists k".
   */
  enum SkolemId
  {
    // exists k. k = a
