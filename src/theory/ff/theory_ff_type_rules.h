...
/**
 * The type of an ideal generated by polynomials over a field F is the type of
 * sets of elements of F.
 */
...
/** The variety of an ideal has the same type as the ideal itself. */
