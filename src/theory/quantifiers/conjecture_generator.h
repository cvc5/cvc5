...
private:
  ...
  public:
    ...
    void eqNotifyPreMerge(TNode t1, TNode t2) override { d_sg.eqNotifyPreMerge(t1, t2); }
    void eqNotifyPostMerge(TNode t1, TNode t2) override { d_sg.eqNotifyPostMerge(t1, t2); }
    void eqNotifyDisequal(TNode t1, TNode t2, TNode reason) override {d_sg.eqNotifyDisequal(t1, t2, reason); }
