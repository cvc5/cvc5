...
class SygusGrammarCons
{
 public:
   ...
   * @param range The type of terms generated by the start symbol of the grammar.
   * @param bvl The input variable list for the grammar (if it exists). If provided, each variable in this list is added as a non-terminal rule.
   */
  ...
  /**
   * Make the type corresponding to the default sygus grammar type returning
   * range with bound variables bvl, with a custom set of initial non-terminal rules.
   *
   * @param opts The options, which impact grammar construction
   * @param range The type of terms generated by the start symbol of the grammar.
   * @param bvl The input variable list for the grammar (if it exists).
   * @param trules The provided set of non-terminal rules.
   */
  static TypeNode mkDefaultSygusType(const Options& opts,
                                     const TypeNode& range,
                                     const Node& bvl,
  ...
  /**
   * Make  the default sygus grammar type returning range with bound variables bvl.
   *
   * @param opts The options, which impact grammar construction
   * @param range The type of terms generated by the start symbol of the grammar.
   * @param bvl The input variable list for the grammar (if it exists). If provided, each variable in this list is added as a non-terminal rule.
  ...
  /**
   * Make the default sygus grammar type returning range with bound variables bvl, with a custom set of initial non-terminal rules.
   *
   * @param opts The options, which impact grammar construction
   * @param range The type of terms generated by the start symbol of the grammar.
   * @param bvl The input variable list for the grammar (if it exists).
