...
class SygusUnif
{
 public:
   ...
   */
  virtual bool constructSolution(std::vector<Node>& sols, std::vector< Node >& lemmas);
 ...
 protected:
   ...
   */
  virtual Node constructSol(Node f, Node e, NodeRole nrole, int ind, std::vector< Node >& lemmas) = 0;
