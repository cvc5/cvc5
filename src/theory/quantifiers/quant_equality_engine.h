...
private:
  ...
  public:
    ...
    void eqNotifyConstantTermMerge(TNode t1, TNode t2) override { d_qee.conflict(t1, t2); }
    void eqNotifyNewClass(TNode t) override { d_qee.eqNotifyNewClass(t); }
    void eqNotifyPreMerge(TNode t1, TNode t2) override { d_qee.eqNotifyPreMerge(t1, t2); }
    void eqNotifyPostMerge(TNode t1, TNode t2) override { d_qee.eqNotifyPostMerge(t1, t2); }
    void eqNotifyDisequal(TNode t1, TNode t2, TNode reason) override {d_qee.eqNotifyDisequal(t1, t2, reason); }
