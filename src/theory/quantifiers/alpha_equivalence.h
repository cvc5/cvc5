...
public:
  ...
  Node d_quant;
  Node registerNode( Node q, std::vector< Node >& tt, std::vector< int >& arg_index );
};
...
public:
  ...
  Node registerNode( Node q, Node t, std::vector< TypeNode >& typs, std::map< TypeNode, int >& typ_count, int index = 0 );
};
