...
* interface:
* (1) When a sygus conjecture is asserted, we call CegConjectureProcess::simplify( q ),
...
public:
  ...
  * 
  * Returns a formula that restricts the enumerative search space (for a given depth) 
  * for a term x of sygus type tn whose top symbol is the tindex^{th} constructor,
