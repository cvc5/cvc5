...
struct QuantifierForallTypeRule {
  inline static TypeNode computeType(NodeManager* nodeManager, TNode n, bool check)
  {
    ...
    CVC4_DCHECK(n.getKind() == kind::FORALL && n.getNumChildren() > 0);
    if( check ){
...
struct QuantifierExistsTypeRule {
  inline static TypeNode computeType(NodeManager* nodeManager, TNode n, bool check)
  {
    ...
    CVC4_DCHECK(n.getKind() == kind::EXISTS && n.getNumChildren() > 0);
    if( check ){
      if( n[ 0 ].getType(check)!=nodeManager->boundVarListType() ){
...
struct QuantifierBoundVarListTypeRule {
  inline static TypeNode computeType(NodeManager* nodeManager, TNode n, bool check)
  {
    CVC4_DCHECK(n.getKind() == kind::BOUND_VAR_LIST);
    if( check ){
...
struct QuantifierInstPatternTypeRule {
  inline static TypeNode computeType(NodeManager* nodeManager, TNode n, bool check)
  {
    CVC4_DCHECK(n.getKind() == kind::INST_PATTERN);
    if( check ){
...
struct QuantifierInstNoPatternTypeRule {
  inline static TypeNode computeType(NodeManager* nodeManager, TNode n, bool check)
  {
    CVC4_DCHECK(n.getKind() == kind::INST_NO_PATTERN);
    return nodeManager->instPatternType();
  }
};/* struct QuantifierInstNoPatternTypeRule */
...
struct QuantifierInstAttributeTypeRule {
  inline static TypeNode computeType(NodeManager* nodeManager, TNode n, bool check)
  {
    CVC4_DCHECK(n.getKind() == kind::INST_ATTRIBUTE);
    return nodeManager->instPatternType();
  }
};/* struct QuantifierInstAttributeTypeRule */
...
struct QuantifierInstPatternListTypeRule {
  inline static TypeNode computeType(NodeManager* nodeManager, TNode n, bool check)
  {
    CVC4_DCHECK(n.getKind() == kind::INST_PATTERN_LIST);
    if( check ){
      for( int i=0; i<(int)n.getNumChildren(); i++ ){
...
struct QuantifierInstClosureTypeRule {
  inline static TypeNode computeType(NodeManager* nodeManager, TNode n, bool check)
  {
    CVC4_DCHECK(n.getKind() == kind::INST_CLOSURE);
    if( check ){
      TypeNode tn = n[0].getType(check);
      if( tn.isBoolean() ){
...
public:
                                     ...
                                     bool check)
  {
    ...
    CVC4_DCHECK(n.getKind() == kind::REWRITE_RULE && n.getNumChildren() == 3);
    if( check ){
      if( n[ 0 ].getType(check)!=nodeManager->boundVarListType() ){
...
public:
  ...
  inline static TypeNode computeType(NodeManager* nodeManager, TNode n, bool check)
  {
    CVC4_DCHECK(n.getKind() == kind::RR_REWRITE);
    if( check ){
...
public:
  ...
  inline static TypeNode computeType(NodeManager* nodeManager, TNode n, bool check)
  {
    CVC4_DCHECK(n.getKind() == kind::RR_REDUCTION
