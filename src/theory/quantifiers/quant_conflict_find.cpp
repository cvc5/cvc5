...
bool MatchGen::isHandledUfTerm( TNode n ) {
  ...
  // ||
  //       n.getKind()==APPLY_CONSTRUCTOR || n.getKind()==APPLY_SELECTOR ||
  //       n.getKind()==APPLY_TESTER;
  // TODO : treat APPLY_TESTER as a T-constraint instead of matching (currently
  // leads to overabundance of instantiations) return
  // inst::Trigger::isAtomicTriggerKind( n.getKind() ) && (
  // !options::qcfTConstraint() || n.getKind()!=APPLY_TESTER );
