...
class BVSolverBitblast : public BVSolver
{
 ...
 private:
   ...
   */
  cvc5::context::CDQueue<Node> d_bbFacts;
   ...
   */
  cvc5::context::CDQueue<Node> d_bbInputFacts;

  /** Corresponds to the SAT literals of the currently asserted facts. */
  cvc5::context::CDList<prop::SatLiteral> d_assumptions;
  ...
  cvc5::context::CDHashMap<Node, prop::SatLiteral> d_factLiteralCache;

  /** Reverse map of `d_factLiteralCache`. */
  cvc5::context::CDHashMap<prop::SatLiteral, Node, prop::SatLiteralHashFunction>
      d_literalFactCache;
