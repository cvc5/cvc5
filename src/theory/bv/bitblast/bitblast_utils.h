...
template <>
inline std::string toString<Node>(const std::vector<Node>& bits)
{
...
template <>
inline Node mkNot<Node>(Node a)
{
  return NodeManager::mkNode(Kind::NOT, a);
}

template <>
inline Node mkOr<Node>(Node a, Node b)
{
...
template <>
inline Node mkAnd<Node>(Node a, Node b)
{
...
template <>
inline Node mkXor<Node>(Node a, Node b)
{
  return NodeManager::mkNode(Kind::XOR, a, b);
}

template <>
inline Node mkIff<Node>(Node a, Node b)
{
  return NodeManager::mkNode(Kind::EQUAL, a, b);
}

template <>
inline Node mkIte<Node>(Node cond, Node a, Node b)
{
...
template <class T>
void inline extractBits(const std::vector<T>& b,
                        std::vector<T>& dest,
                        unsigned lo,
                        unsigned hi)
{
 ...
 */
template <class T>
T inline rippleCarryAdder(const std::vector<T>& a,
...
template <class T>
T inline uLessThanBB(const std::vector<T>& a,
                     const std::vector<T>& b,
                     bool orEqual)
{
...
template <class T>
T inline sLessThanBB(const std::vector<T>& a,
                     const std::vector<T>& b,
                     bool orEqual)
{
  Assert(a.size() && b.size());
