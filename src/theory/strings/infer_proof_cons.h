 ...
 * returns applications of the rule MACRO_STRING_INFERENCE, which store the arguments
...
class InferProofCons : protected EnvObj, public ProofGenerator
{
 ...
 public:
   ...
   *
   * This returns the appropriate application of MACRO_STRING_INFERENCE so that it
  ...
  /**
   * Pack arguments of a MACRO_STRING_INFERENCE rule application in args. This proof
