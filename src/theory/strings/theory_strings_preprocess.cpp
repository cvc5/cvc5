                               ...
                               size_t alphaCard)
{
  ...
  else if (t.getKind() == Kind::STRING_REPLACE_RE)
  {
    ...
    Node k1 = sc->mkSkolemFun(SkolemFunId::RE_FIRST_MATCH_PRE, x, y);
    Node k2 = sc->mkSkolemFun(SkolemFunId::RE_FIRST_MATCH, x, y);
    Node k3 = sc->mkSkolemFun(SkolemFunId::RE_FIRST_MATCH_POST, x, y);
