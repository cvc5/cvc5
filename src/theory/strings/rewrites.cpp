...
const char* toString(Rewrite r)
{
  switch (r)
  {
    ...
    case Rewrite::RE_INTER_CONST_CONST_CONFLICT: return "RE_INTER_CONST_CONST_CONFLICT";
    case Rewrite::RE_INTER_CONST_RE_CONFLICT: return "RE_INTER_CONST_RE_CONFLICT";
