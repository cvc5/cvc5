...
class StringsEntail
{
 public:
   ...
   * @param ch1 Along with ch2, this stores how the argument s of node was partitioned.
   * In particular, s is equivalent to (str.++ ch1 ch2), and we have determined based
   * on n and m that ch1/ch2 are in separate parts of the computation of the substring,
   * e.g. ch1 is what is contained in the substring, and ch2 is not contained, or vice
   * versa.
