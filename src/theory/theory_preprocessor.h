...
class TheoryPreprocessor
{
 ...
 public:
  ...
  void clearCache();
  /**
   * Preprocesses node and stores it along with lemmas generated by preprocessing
   * into the assertion pipeline lemmas. The (optional) argument lcp is the
   * proof that stores a proof of all top-level formulas in lemmas, assuming
