                                 ...
                                 ProofGenerator* defParent)
{
  ...
  d_proofInternal.reset(
      new LazyCDProofChain(pnm, true, ctx, d_epg.get(), true, "CircuitPropInternalLazyChain"));
  if (defParent != nullptr)
  {
    ...
    d_proofExternal.reset(
        new LazyCDProofChain(pnm, true, ctx, defParent, false, "CircuitPropExternalLazyChain"));
  }
}
