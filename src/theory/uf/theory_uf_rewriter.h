...
{
 public:
  TheoryUfRewriter(Rewriter * rr, bool isHigherOrder = false);
  /** post-rewrite */
 ...
 private:
  ...
  /** 
   * Rewriter currently needed for normalizing array constants to check whether
   * a function needs normalization.
   */
  Rewriter * d_rr;
