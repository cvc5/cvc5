...
public:
  ...
  void clear();
  /** setValue function */
  void setValue( const TheoryModel* m, Node n, Node v, std::vector< int >& indexOrder, bool ground, int argIndex );
  /** getFunctionValue */
...
public:
  void debugPrint( std::ostream& out, const TheoryModel* m, std::vector< int >& indexOrder, int ind = 0, int arg = 0 );
};
