...
//set value function
void UfModelTreeNode::setValue( const TheoryModel* m, Node n, Node v, std::vector< int >& indexOrder, bool ground, int argIndex ){
  if( d_data.empty() ){
...
void UfModelTreeNode::debugPrint( std::ostream& out, const TheoryModel* m, std::vector< int >& indexOrder, int ind, int arg ){
  if( !d_data.empty() ){
