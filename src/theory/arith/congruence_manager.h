...
public:
  ...
  ArithCongruenceManager(context::Context* satContext, context::UserContext* u, ConstraintDatabase&, SetupLiteralCallBack, const ArithVariables&, RaiseEqualityEngineConflict raiseConflict);
