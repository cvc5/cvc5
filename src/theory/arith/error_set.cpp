...
void ErrorSet::recomputeAmount(ErrorInformation& ei, options::ErrorSelectionRule rule){
  switch(rule){
...
ComparatorPivotRule::ComparatorPivotRule(const ErrorSet* es, options::ErrorSelectionRule r):
