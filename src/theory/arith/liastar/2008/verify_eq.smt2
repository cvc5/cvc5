...
(assert 
 (= 
  ...
  (or   
    ...
    (exists ((l1 Int) (l2 Int)) (and (>= l1 0) (>= l2 0) (= x1 0) (= L l1 ) (= x (+ 1 l1 l2)) (= z1 0) (= z2 1)))
    (exists ((l1 Int) (l2 Int)) (and (>= l1 0) (>= l2 0) (= x1 1) (= L l1 ) (= x (+ 1 l1 l2)) (= z1 1) (= z2 1)))
    (exists ((l1 Int) (l2 Int)) (and (>= l1 0) (>= l2 0) (= x1 (+ 1 l1)) (= L (+ 1 l1 l2) ) (= x l2) (= z1 0) (= z2 0)))
    (exists ((l1 Int) (l2 Int) (l3 Int)) (and (>= l1 0) (>= l2 0) (>= l3 0) (= x1 (+ 2 l1 l3)) (= L (+ 1 l1 l2) ) (= x l2) (= z1 1) (= z2 0)))
    (exists ((l1 Int) (l2 Int) (l3 Int)) (and (>= l1 0) (>= l2 0) (>= l3 0) (= x1 l1) (= L (+ l1 l2) ) (= x (+ 1 l3)) (= z1 (+ 1 l3)) (= z2 0)))
  )
 )
)
