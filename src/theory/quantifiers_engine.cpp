...
void QuantifiersEngine::check( Theory::Effort e ){
  ...
  if( needsCheck ){
    ...
    if( Trace.isOn("quant-engine-debug") ){
      ...
      Trace("quant-engine-debug") << "  Theory engine finished : " << !theoryEngineNeedsCheck() << std::endl;
...
bool QuantifiersEngine::getInstWhenNeedsCheck( Theory::Effort e ) {
  ...
  {
    performCheck = ( ( e==Theory::EFFORT_FULL && !theoryEngineNeedsCheck() && d_ierCounter%d_inst_when_phase!=0 ) || e==Theory::EFFORT_LAST_CALL );
  }
