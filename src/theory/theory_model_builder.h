...
class TheoryEngineModelBuilder : public ModelBuilder
{
 ...
 protected:
   ...
   */
  bool isAssignableEqc(TheoryModel* m, TNode r, std::vector<Node>& eset, bool& evaluable);
   ...
   * evaluable to true if there is a term in r that is not assignable.
   */
  Node processEqcInternal(TheoryModel* m, TNode r, bool& assignable, bool& evaluable, std::vector<Node>& eset, bool doEval, bool doComputeEset);
