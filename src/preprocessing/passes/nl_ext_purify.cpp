    ...
    AssertionPipeline* assertionsToPreprocess)
{
  ...
  for (unsigned i = 0; i < size; ++i)
  {
    ...
    if (a != ap)
    {
      assertionsToPreprocess->replace(i, ap, nullptr, TrustId::PREPROCESS_NL_EXT_PURIFY);
      Trace("nl-ext-purify")
  ...
  if (!var_eq.empty())
  {
    ...
    {
      assertionsToPreprocess->push_back(ve, false, nullptr, TrustId::PREPROCESS_NL_EXT_PURIFY_LEMMA);
    }
  }
