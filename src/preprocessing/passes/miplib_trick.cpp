        ...
        else
        {
          ...
          for (; ii != iiend; ++ii)
          {
            ...
            if (varRef.isNull())
            {
              ...
              assertionsToPreprocess->push_back(n, false, nullptr, TrustId::PREPROCESS_MIPLIB_TRICK_LEMMA);
          ...
          assertionsToPreprocess->push_back(newAssertion, false, nullptr, TrustId::PREPROCESS_MIPLIB_TRICK_LEMMA);
  ...
  if (!removeAssertions.empty())
  {
    ...
    for (size_t i = 0, size = assertionsToPreprocess->size(); i < size; ++i)
    {
      ...
      if (removeAssertions.find(assertion.getId()) != removeAssertions.end())
      {
        ...
        assertionsToPreprocess->replace(i, trueNode, nullptr, TrustId::PREPROCESS_MIPLIB_TRICK);
      ...
      assertionsToPreprocess->replace(
          i, top_level_substs.apply(assertion), nullptr, TrustId::PREPROCESS_MIPLIB_TRICK);
