...
const static std::unordered_map<Kind, CVC4::Kind, KindHashFunction> s_kinds{
    ...
    {INST_POOL, CVC4::Kind::INST_POOL},
    {INST_ADD_TO_POOL, CVC4::Kind::INST_ADD_TO_POOL},
    {SKOLEM_ADD_TO_POOL, CVC4::Kind::SKOLEM_ADD_TO_POOL},
...
const static std::unordered_map<CVC4::Kind, Kind, CVC4::kind::KindHashFunction>
    s_kinds_internal{
        ...
        {CVC4::Kind::INST_POOL, INST_POOL},
        {CVC4::Kind::INST_ADD_TO_POOL, INST_ADD_TO_POOL},
        {CVC4::Kind::SKOLEM_ADD_TO_POOL, SKOLEM_ADD_TO_POOL},
