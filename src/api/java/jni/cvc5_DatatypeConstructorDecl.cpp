 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_cvc5_DatatypeConstructorDecl_deletePointer(JNIEnv*,
                                                                       jclass,
                                                                       jlong);
 ...
 * Signature: (J)Z
 */
JNIEXPORT jboolean JNICALL Java_cvc5_DatatypeConstructorDecl_isNull(JNIEnv*,
                                                                    jobject,
                                                                    jlong);
 ...
 */
JNIEXPORT jstring JNICALL Java_cvc5_DatatypeConstructorDecl_toString(JNIEnv*,
                                                                     jobject,
                                                                     jlong);
