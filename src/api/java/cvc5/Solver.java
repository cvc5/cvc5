...
public class Solver implements IPointer
{
  ...
  public boolean supportsFloatingPoint()
    ...
    std::vector<Sort> mkDatatypeSorts(
        const std::vector<DatatypeDecl>& dtypedecls,
        const std::set<Sort>& unresolvedSorts)
     ...
     */
    Term mkTuple(std::vector<Sort>& sorts,
                 Term[] terms)
  ...
  public boolean getAbduct(Term conj, Term output)
   ...
   private native boolean getAbduct(long pointer, long conjPointer, long grammarPointer, long outputPointer);
    ...
    private native long mkSygusGrammar(long pointer, long[] boundVarPointers, long[] ntSymbolPointers);
    ...
    public Term synthFun(String  symbol,
                  ...
                  Sort& sort)
     {
      ...
      private native long synthFun(long pointer, String symbol, long[] boundVarPointers, long sortPointer);
  ...
  {
    long [] boundVarPointers = Utils.getPointers(boundVars);
          long termPointer = synthFun(pointer, symbol, boundVarPointers, sort.getPointer(), grammar.getPointer());
          return new Term(solver, termPointer);
  }

  private native long synthFun(long pointer, String symbol, long[] boundVarPointers, long sortPointer , long grammarPointer);
    ...
    private native long synthInv(long pointer, String symbol, long[] boundVarPointers, long grammarPointer);
   ...
   private native void addSygusConstraint(long pointer, long invPointer, long prePointer, long transPointer,
   long postPointer);
