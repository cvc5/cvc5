            ...
            default_tty_ops: {
                get_char: function (tty) {
                    if (!tty.input.length) {
                        ...
                        console.log(result)
                        // result='(set-logic QF_SLIA) (set-option :produce-models true) (define-const ab String "ab") (define-const abc String "abc") (declare-const x String) (declare-const y String) (declare-const z String) (assert (= (str.++ x ab y) (str.++ abc z))) (assert (>= (str.len y) 0)) (define-const r RegLan  (re.union  (re.++ (str.to_re "ab") (re.* (re.range "c" "e")) (str.to_re "f"))   (str.to_re "f")  (str.to_re "h")) )(assert (str.in_re (str.++ "s1" "s2") r)) (check-sat)'
                ...
                put_char: function (tty, val) {
                    if (val === null || val === 10) {
                        ...
                        console.log(val)
                        console.log(UTF8ArrayToString([val], 0))
