...

{
  try (Solver slv = new Solver())
  {
    ...
    // union disjoint does not distribute over intersection
    {
      ...
      System.out.println(A + ": " + slv.getValue(new Term[] {A}));
      System.out.println(B + ": " + slv.getValue(new Term[] {B}));
      System.out.println(C + ": " + slv.getValue(new Term[] {C}));
      System.out.println(lhs + ": " + slv.getValue(new Term[] {lhs}));
      System.out.println(rhs + ": " + slv.getValue(new Term[] {rhs}));
    }
