...
int main()
{
  ...
  Term x_31_1 = slv.mkTermFromOp(ext_31_1, x);

  Op ext_30_0 = slv.mkOp(BITVECTOR_EXTRACT, 30, 0);
  Term x_30_0 = slv.mkTermFromOp(ext_30_0, x);

  Op ext_31_31 = slv.mkOp(BITVECTOR_EXTRACT, 31, 31);
  Term x_31_31 = slv.mkTermFromOp(ext_31_31, x);

  Op ext_0_0 = slv.mkOp(BITVECTOR_EXTRACT, 0, 0);
  Term x_0_0 = slv.mkTermFromOp(ext_0_0, x);
