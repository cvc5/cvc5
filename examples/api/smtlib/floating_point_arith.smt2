...
(assert (distinct ((_ fp.to_sbv 16) RTP d) ((_ fp.to_sbv 16) RTN d)))
(echo "Expect sat")
(check-sat)

(echo "Value of `d`:")
(get-value (d))
(echo "Value of `((_ fp.to_sbv 16) RTP d)`:")
(get-value (((_ fp.to_sbv 16) RTP d)))
(echo "Value of `((_ fp.to_sbv 16) RTN d)`:")
(get-value (((_ fp.to_sbv 16) RTN d)))
