...
if __name__ == "__main__":
    ...
    op = tm.mkOp(Kind.FLOATINGPOINT_TO_SBV, 16)  # (_ fp.to_sbv 16)
    ...
    print(f'Value of `((_ fp.to_sbv 16) RTP d)`: {slv.getValue(lhs)}')
    print(f'Value of `((_ fp.to_sbv 16) RTN d)`: {slv.getValue(rhs)}')
