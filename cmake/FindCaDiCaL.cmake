...
if(CaDiCaL_INCLUDE_DIR AND CaDiCaL_LIBRARIES)
    ...
    if(CaDiCaL_BINARY)
      execute_process(
        COMMAND ${CaDiCaL_BINARY} --version
        OUTPUT_VARIALE CaDiCaL_VERSION
      )
    else()
      set(CaDiCaL_VERSION "")
    endif()
...
if(NOT CaDiCaL_FOUND_SYSTEM)
    ...
    # the configure scripts unnecessarily fails for cross compilation
    # thus we do the bare minimum from the configure script here
