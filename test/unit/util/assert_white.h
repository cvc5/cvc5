...
public:
 void testAssertDeprecated()
 {
   ...
   TS_ASSERT_THROWS(AssertDeprecated(false), AssertionException&);
   ...
   TS_ASSERT_THROWS(AlwaysAssertDeprecated(false), AssertionException&);
 ...
 void testReallyLongAssertDeprecated()
 {
   string msg(1034, 'x');
   try
   {
     AlwaysAssertDeprecated(false, msg.c_str());
   ...
   catch (AssertionException& e)
   {
     ...
     const char* firstPart =
         "Assertion failure\nvoid "
         "AssertWhite::testReallyLongAssertDeprecated()\n";
     string lastPartStr = "\n\n  false\n" + msg;
   ...
   try
   {
     AlwaysAssertDeprecated(false, fmt.c_str(), arg.c_str());
     TS_FAIL("Should have thrown an exception !");
   }
   catch (AssertionException& e)
   {
