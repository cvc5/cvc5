...
{
  DatatypeDecl dtypeSpec(d_solver.get(),"list");
  ...
  DatatypeDecl throwsDtypeSpec(d_solver.get(),"list");
...
void SolverBlack::testMkTermFromOp()
{
  ...
  DatatypeDecl listDecl(d_solver.get(),"paramlist", sort);
  DatatypeConstructorDecl cons("cons");
  DatatypeConstructorDecl nil("nil");
...
void SolverBlack::testGetOp()
{
  ...
  DatatypeDecl consListSpec(d_solver.get(),"list");
  DatatypeConstructorDecl cons("cons");
  DatatypeSelectorDecl head("head", d_solver->getIntegerSort());
  DatatypeSelectorDecl tail("tail", DatatypeDeclSelfSort());
  cons.addSelector(head);
