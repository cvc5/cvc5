...
TEST_F(TestApiBlackSolver, proj_issue421)
{
  Solver slv;
  slv.setLogic("QF_ALL");
...
TEST_F(TestApiBlackSolver, proj_issue361)                                                 
{                                                                               
  ...
  ASSERT_TRUE (d_solver.checkSatAssuming(d_solver.mkTerm(EQUAL, t250, v)).isSat());                                                                                                     
}
