...
TEST_F(TestApiBlackSolver, getRealSort) { ASSERT_NO_THROW(d_tm.getRealSort()); }
...
TEST_F(TestApiBlackSolver, mkPi) { ASSERT_NO_THROW(d_tm.mkPi()); }
...
TEST_F(TestApiBlackSolver, mkSepEmp) { ASSERT_NO_THROW(d_tm.mkSepEmp()); }
