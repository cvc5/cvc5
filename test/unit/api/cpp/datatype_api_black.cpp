...
TEST_F(TestApiBlackDatatype, mkDatatypeSorts)
{
  ...
  Sort unresTree = d_solver.mkUnresolvedSort(0, "tree");
  Sort unresList = d_solver.mkUnresolvedSort(0, "list");
...
TEST_F(TestApiBlackDatatype, datatypeSimplyRec)
{
  ...
  // Make unresolved types as placeholders
  std::set<Sort> unresTypes;
  Sort unresWList = d_solver.mkUnresolvedSort(0, "wlist");
  Sort unresList = d_solver.mkUnresolvedSort(0, "list");
  Sort unresNs = d_solver.mkUnresolvedSort(0, "ns");
   ...
   */
  unresTypes.clear();
  Sort unresNs2 = d_solver.mkUnresolvedSort(0, "ns2");
   ...
   */
  unresTypes.clear();
  Sort unresNs3 = d_solver.mkUnresolvedSort(0, "ns3");
  unresTypes.insert(unresNs3);
  Sort unresList3 = d_solver.mkUnresolvedSort(0, "list3");
   ...
   */
  unresTypes.clear();
  Sort unresNs4 = d_solver.mkUnresolvedSort(0, "ns4");
  unresTypes.insert(unresNs4);
  Sort unresList4 = d_solver.mkUnresolvedSort(0, "list4");
