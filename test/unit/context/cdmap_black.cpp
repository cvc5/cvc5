...
class TestContextBlackCDMap : public TestContext
{
 protected:
...
TEST_F(TestContextBlackCDMap, simple_sequence)
{
...
TEST_F(TestContextBlackCDMap, simple_sequence_fewer_finds)
{
...
TEST_F(TestContextBlackCDMap, insert_at_context_level_zero)
{
  CDHashMap<int, int> map(d_context.get());
