...
class DummyTheory : public Theory {
 public:
  ...
  DummyTheory(Context* ctxt, UserContext* uctxt, OutputChannel& out,
              Valuation valuation, const LogicInfo& logicInfo, ProofChecker * pc)
      : Theory(theory::THEORY_BUILTIN, ctxt, uctxt, out, valuation, logicInfo, pc)
  {}
 ...
 public:
  void setUp() override
  {
    ...
    d_dummy = new DummyTheory(
        d_ctxt, d_uctxt, d_outputChannel, Valuation(NULL), *d_logicInfo, nullptr);
