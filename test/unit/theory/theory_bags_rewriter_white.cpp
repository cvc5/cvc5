...
TEST_F(TestTheoryWhiteBagsRewriter, bag_equality)
{
  ...
  Node A = d_nodeManager->mkNode(Kind::BAG_MAKE, x, c);
  Node B = d_nodeManager->mkNode(Kind::BAG_MAKE, y, d);
  ...
  Node constantBag = d_nodeManager->mkNode(
      Kind::BAG_MAKE, emptyString, d_nodeManager->mkConstInt(Rational(1)));
...
TEST_F(TestTheoryWhiteBagsRewriter, mkBag_constant_element)
{
  ...
  Node zero = d_nodeManager->mkNode(
      Kind::BAG_MAKE, elements[0], d_nodeManager->mkConstInt(Rational(0)));
...
TEST_F(TestTheoryWhiteBagsRewriter, mkBag_variable_element)
{
  ...
  Node variable = d_nodeManager->mkNode(
      Kind::BAG_MAKE, skolem, d_nodeManager->mkConstInt(Rational(-1)));
  Node negative = d_nodeManager->mkNode(
      Kind::BAG_MAKE, skolem, d_nodeManager->mkConstInt(Rational(-1)));
  Node zero = d_nodeManager->mkNode(
      Kind::BAG_MAKE, skolem, d_nodeManager->mkConstInt(Rational(0)));
  Node positive = d_nodeManager->mkNode(
      Kind::BAG_MAKE, skolem, d_nodeManager->mkConstInt(Rational(1)));
  Node emptybag = d_nodeManager->mkConst(
      EmptyBag(d_nodeManager->mkBagType(d_nodeManager->stringType())));
...
TEST_F(TestTheoryWhiteBagsRewriter, bag_count)
{
  ...
  Node n1 = d_nodeManager->mkNode(Kind::BAG_COUNT, skolem, emptyBag);
  ...
  Node bag = d_nodeManager->mkNode(Kind::BAG_MAKE, skolem, three);
  Node n2 = d_nodeManager->mkNode(Kind::BAG_COUNT, skolem, bag);
  RewriteResponse response2 = d_rewriter->postRewrite(n2);
...
TEST_F(TestTheoryWhiteBagsRewriter, union_max)
{
  ...
  Node A = d_nodeManager->mkNode(
      Kind::BAG_MAKE, elements[0], d_nodeManager->mkConstInt(Rational(n)));
  Node B = d_nodeManager->mkNode(
      Kind::BAG_MAKE, elements[1], d_nodeManager->mkConstInt(Rational(n + 1)));
  Node unionMaxAB = d_nodeManager->mkNode(Kind::BAG_UNION_MAX, A, B);
  Node unionMaxBA = d_nodeManager->mkNode(Kind::BAG_UNION_MAX, B, A);
  Node unionDisjointAB = d_nodeManager->mkNode(Kind::BAG_UNION_DISJOINT, A, B);
  Node unionDisjointBA = d_nodeManager->mkNode(Kind::BAG_UNION_DISJOINT, B, A);

  // (bag.union_max A (as bag.empty (Bag String))) = A
  Node unionMax1 = d_nodeManager->mkNode(Kind::BAG_UNION_MAX, A, emptyBag);
  ...
  Node unionMax2 = d_nodeManager->mkNode(Kind::BAG_UNION_MAX, emptyBag, A);
  RewriteResponse response2 = d_rewriter->postRewrite(unionMax2);
  ASSERT_TRUE(response2.d_node == A
              && response2.d_status == REWRITE_AGAIN_FULL);

  // (bag.union_max A A) = A
  Node unionMax3 = d_nodeManager->mkNode(Kind::BAG_UNION_MAX, A, A);
  ...
  Node unionMax4 = d_nodeManager->mkNode(Kind::BAG_UNION_MAX, A, unionMaxAB);
  ...
  Node unionMax5 = d_nodeManager->mkNode(Kind::BAG_UNION_MAX, A, unionMaxBA);
  ...
  Node unionMax6 = d_nodeManager->mkNode(Kind::BAG_UNION_MAX, unionMaxAB, A);
  ...
  Node unionMax7 = d_nodeManager->mkNode(Kind::BAG_UNION_MAX, unionMaxBA, A);
  ...
  Node unionMax8 =
      d_nodeManager->mkNode(Kind::BAG_UNION_MAX, A, unionDisjointAB);
  ...
  Node unionMax9 =
      d_nodeManager->mkNode(Kind::BAG_UNION_MAX, A, unionDisjointBA);
  ...
  Node unionMax10 =
      d_nodeManager->mkNode(Kind::BAG_UNION_MAX, unionDisjointAB, A);
  ...
  Node unionMax11 =
      d_nodeManager->mkNode(Kind::BAG_UNION_MAX, unionDisjointBA, A);
...
TEST_F(TestTheoryWhiteBagsRewriter, union_disjoint)
{
  ...
  Node C = d_nodeManager->mkNode(
      Kind::BAG_MAKE, elements[2], d_nodeManager->mkConstInt(Rational(n + 2)));

  Node unionDisjointAB = d_nodeManager->mkNode(Kind::BAG_UNION_DISJOINT, A, B);
  Node unionDisjointBA = d_nodeManager->mkNode(Kind::BAG_UNION_DISJOINT, B, A);
  Node unionMaxAB = d_nodeManager->mkNode(Kind::BAG_UNION_MAX, A, B);
  Node unionMaxAC = d_nodeManager->mkNode(Kind::BAG_UNION_MAX, A, C);
  Node unionMaxBA = d_nodeManager->mkNode(Kind::BAG_UNION_MAX, B, A);
  Node intersectionAB = d_nodeManager->mkNode(Kind::BAG_INTER_MIN, A, B);
  Node intersectionBA = d_nodeManager->mkNode(Kind::BAG_INTER_MIN, B, A);

  // (bag.union_disjoint A (as bag.empty (Bag String))) = A
  Node unionDisjoint1 =
      d_nodeManager->mkNode(Kind::BAG_UNION_DISJOINT, A, emptyBag);
  ...
  Node unionDisjoint2 =
      d_nodeManager->mkNode(Kind::BAG_UNION_DISJOINT, emptyBag, A);
  ...
  Node unionDisjoint3 = d_nodeManager->mkNode(
      Kind::BAG_UNION_DISJOINT, unionMaxAB, intersectionBA);
  ...
  Node unionDisjoint4 = d_nodeManager->mkNode(
      Kind::BAG_UNION_DISJOINT, unionMaxBA, intersectionBA);
  ...
  // (bag.union_disjoint (bag.inter_min B A)) (bag.union_max A B) =
  //          (bag.union_disjoint B A) // sum(a,b) = max(a,b) + min(a,b)
  Node unionDisjoint5 = d_nodeManager->mkNode(
      Kind::BAG_UNION_DISJOINT, unionMaxAC, intersectionAB);
...
TEST_F(TestTheoryWhiteBagsRewriter, intersection_min)
{
  ...
  Node n1 = d_nodeManager->mkNode(Kind::BAG_INTER_MIN, A, emptyBag);
  RewriteResponse response1 = d_rewriter->postRewrite(n1);
  ...
  Node n8 = d_nodeManager->mkNode(Kind::BAG_INTER_MIN, A, unionDisjointAB);
  ...
  Node n9 = d_nodeManager->mkNode(Kind::BAG_INTER_MIN, A, unionDisjointBA);
  ...
  Node n10 = d_nodeManager->mkNode(Kind::BAG_INTER_MIN, unionDisjointAB, A);
  ...
  Node n11 = d_nodeManager->mkNode(Kind::BAG_INTER_MIN, unionDisjointBA, A);
...
TEST_F(TestTheoryWhiteBagsRewriter, difference_subtract)
{
  ...
  Node n1 = d_nodeManager->mkNode(Kind::BAG_DIFFERENCE_SUBTRACT, A, emptyBag);
  RewriteResponse response1 = d_rewriter->postRewrite(n1);
  ASSERT_TRUE(response1.d_node == A
              && response1.d_status == REWRITE_AGAIN_FULL);
  ...
  // (as bag.empty (Bag String))
  Node n2 = d_nodeManager->mkNode(Kind::BAG_DIFFERENCE_SUBTRACT, emptyBag, A);
  RewriteResponse response2 = d_rewriter->postRewrite(n2);
  ASSERT_TRUE(response2.d_node == emptyBag
              && response2.d_status == REWRITE_AGAIN_FULL);

  // (bag.difference_subtract A A) = (as bag.empty (Bag String))
  Node n3 = d_nodeManager->mkNode(Kind::BAG_DIFFERENCE_SUBTRACT, A, A);
  RewriteResponse response3 = d_rewriter->postRewrite(n3);
  ...
  Node n4 =
      d_nodeManager->mkNode(Kind::BAG_DIFFERENCE_SUBTRACT, unionDisjointAB, A);
  RewriteResponse response4 = d_rewriter->postRewrite(n4);
  ...
  Node n5 =
      d_nodeManager->mkNode(Kind::BAG_DIFFERENCE_SUBTRACT, unionDisjointBA, A);
  RewriteResponse response5 = d_rewriter->postRewrite(n5);
  ...
  // (as bag.empty (Bag String))
  Node n6 =
      d_nodeManager->mkNode(Kind::BAG_DIFFERENCE_SUBTRACT, A, unionDisjointAB);
  RewriteResponse response6 = d_rewriter->postRewrite(n6);
  ...
  // (as bag.empty (Bag String))
  Node n7 =
      d_nodeManager->mkNode(Kind::BAG_DIFFERENCE_SUBTRACT, A, unionDisjointBA);
  RewriteResponse response7 = d_rewriter->postRewrite(n7);
  ...
  // (as bag.empty (Bag String))
  Node n8 = d_nodeManager->mkNode(Kind::BAG_DIFFERENCE_SUBTRACT, A, unionMaxAB);
  RewriteResponse response8 = d_rewriter->postRewrite(n8);
  ...
  // (as bag.empty (Bag String))
  Node n9 = d_nodeManager->mkNode(Kind::BAG_DIFFERENCE_SUBTRACT, A, unionMaxBA);
  RewriteResponse response9 = d_rewriter->postRewrite(n9);
  ...
  // (as bag.empty (Bag String))
  Node n10 =
      d_nodeManager->mkNode(Kind::BAG_DIFFERENCE_SUBTRACT, intersectionAB, A);
  RewriteResponse response10 = d_rewriter->postRewrite(n10);
  ...
  // (as bag.empty (Bag String))
  Node n11 =
      d_nodeManager->mkNode(Kind::BAG_DIFFERENCE_SUBTRACT, intersectionBA, A);
  RewriteResponse response11 = d_rewriter->postRewrite(n11);
...
TEST_F(TestTheoryWhiteBagsRewriter, difference_remove)
{
  ...
  Node n1 = d_nodeManager->mkNode(Kind::BAG_DIFFERENCE_REMOVE, A, emptyBag);
  RewriteResponse response1 = d_rewriter->postRewrite(n1);
  ASSERT_TRUE(response1.d_node == A
              && response1.d_status == REWRITE_AGAIN_FULL);
  ...
  // (as bag.empty (Bag String))
  Node n2 = d_nodeManager->mkNode(Kind::BAG_DIFFERENCE_REMOVE, emptyBag, A);
  RewriteResponse response2 = d_rewriter->postRewrite(n2);
  ASSERT_TRUE(response2.d_node == emptyBag
              && response2.d_status == REWRITE_AGAIN_FULL);

  // (bag.difference_remove A A) = (as bag.empty (Bag String))
  Node n3 = d_nodeManager->mkNode(Kind::BAG_DIFFERENCE_REMOVE, A, A);
  RewriteResponse response3 = d_rewriter->postRewrite(n3);
  ASSERT_TRUE(response3.d_node == emptyBag
              && response3.d_status == REWRITE_AGAIN_FULL);
  ...
  // (as bag.empty (Bag String))
  Node n6 =
      d_nodeManager->mkNode(Kind::BAG_DIFFERENCE_REMOVE, A, unionDisjointAB);
  RewriteResponse response6 = d_rewriter->postRewrite(n6);
  ASSERT_TRUE(response6.d_node == emptyBag
              && response6.d_status == REWRITE_AGAIN_FULL);
  ...
  // (as bag.empty (Bag String))
  Node n7 =
      d_nodeManager->mkNode(Kind::BAG_DIFFERENCE_REMOVE, A, unionDisjointBA);
  RewriteResponse response7 = d_rewriter->postRewrite(n7);
  ASSERT_TRUE(response7.d_node == emptyBag
              && response7.d_status == REWRITE_AGAIN_FULL);
  ...
  // (as bag.empty (Bag String))
  Node n8 = d_nodeManager->mkNode(Kind::BAG_DIFFERENCE_REMOVE, A, unionMaxAB);
  RewriteResponse response8 = d_rewriter->postRewrite(n8);
  ASSERT_TRUE(response8.d_node == emptyBag
              && response8.d_status == REWRITE_AGAIN_FULL);
  ...
  // (as bag.empty (Bag String))
  Node n9 = d_nodeManager->mkNode(Kind::BAG_DIFFERENCE_REMOVE, A, unionMaxBA);
  RewriteResponse response9 = d_rewriter->postRewrite(n9);
  ASSERT_TRUE(response9.d_node == emptyBag
              && response9.d_status == REWRITE_AGAIN_FULL);
  ...
  // (as bag.empty (Bag String))
  Node n10 =
      d_nodeManager->mkNode(Kind::BAG_DIFFERENCE_REMOVE, intersectionAB, A);
  RewriteResponse response10 = d_rewriter->postRewrite(n10);
  ASSERT_TRUE(response10.d_node == emptyBag
              && response10.d_status == REWRITE_AGAIN_FULL);
  ...
  // (as bag.empty (Bag String))
  Node n11 =
      d_nodeManager->mkNode(Kind::BAG_DIFFERENCE_REMOVE, intersectionBA, A);
  RewriteResponse response11 = d_rewriter->postRewrite(n11);
  ASSERT_TRUE(response11.d_node == emptyBag
              && response11.d_status == REWRITE_AGAIN_FULL);
}
...
TEST_F(TestTheoryWhiteBagsRewriter, choose)
{
  ...
  Node n1 = d_nodeManager->mkNode(Kind::BAG_CHOOSE, bag);
  RewriteResponse response1 = d_rewriter->postRewrite(n1);
...
TEST_F(TestTheoryWhiteBagsRewriter, bag_card)
{
  ...
  std::vector<Node> elements = getNStrings(2);
  Node A = d_nodeManager->mkNode(
      Kind::BAG_MAKE, elements[0], d_nodeManager->mkConstInt(Rational(4)));
  Node B = d_nodeManager->mkNode(
      Kind::BAG_MAKE, elements[1], d_nodeManager->mkConstInt(Rational(5)));
  Node unionDisjointAB = d_nodeManager->mkNode(Kind::BAG_UNION_DISJOINT, A, B);

  // (bag.card (as bag.empty (Bag String)) = 0
  Node n1 = d_nodeManager->mkNode(Kind::BAG_CARD, emptyBag);
  RewriteResponse response1 = d_rewriter->postRewrite(n1);
  ASSERT_TRUE(response1.d_node == zero
              && response1.d_status == REWRITE_AGAIN_FULL);

  // (bag.card (bag x c)) = c where c is a constant > 0
  Node n2 = d_nodeManager->mkNode(Kind::BAG_CARD, bag);
  RewriteResponse response2 = d_rewriter->postRewrite(n2);
...
TEST_F(TestTheoryWhiteBagsRewriter, map)
{
  ...
  Node lambda = d_nodeManager->mkNode(Kind::LAMBDA, bound, empty);

  // (bag.map (lambda ((x U))  t) (as bag.empty (Bag String)) =
  // (as bag.empty (Bag String))
  Node n1 = d_nodeManager->mkNode(Kind::BAG_MAP, lambda, emptybagString);
  RewriteResponse response1 = d_rewriter->postRewrite(n1);
  ...
  Node A = d_nodeManager->mkNode(
      Kind::BAG_MAKE, a, d_nodeManager->mkConstInt(Rational(3)));
  Node B = d_nodeManager->mkNode(
      Kind::BAG_MAKE, b, d_nodeManager->mkConstInt(Rational(4)));
  Node unionDisjointAB = d_nodeManager->mkNode(Kind::BAG_UNION_DISJOINT, A, B);
  ...
  // (bag "" 7))
  Node n2 = d_nodeManager->mkNode(Kind::BAG_MAP, lambda, unionDisjointAB);
  Node rewritten = rr->rewrite(n2);
  Node bag = d_nodeManager->mkNode(
      Kind::BAG_MAKE, empty, d_nodeManager->mkConstInt(Rational(7)));
  ...
  Node unionDisjointK1K2 =
      d_nodeManager->mkNode(Kind::BAG_UNION_DISJOINT, k1, k2);
  Node n3 = d_nodeManager->mkNode(Kind::BAG_MAP, f, unionDisjointK1K2);
  Node rewritten3 = rr->rewrite(n3);
  Node mapK1 = d_nodeManager->mkNode(Kind::BAG_MAP, f, k1);
  Node mapK2 = d_nodeManager->mkNode(Kind::BAG_MAP, f, k2);
  Node unionDisjointMapK1K2 =
      d_nodeManager->mkNode(Kind::BAG_UNION_DISJOINT, mapK1, mapK2);
...
TEST_F(TestTheoryWhiteBagsRewriter, fold)
{
  ...
  Node xy = d_nodeManager->mkNode(Kind::BOUND_VAR_LIST, x, y);
  Node sum = d_nodeManager->mkNode(Kind::ADD, x, y);
  ...
  f = d_nodeManager->mkNode(Kind::LAMBDA, xy, sum);
