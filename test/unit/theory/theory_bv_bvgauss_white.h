...
public:
  ...
  void testGaussElim ()
  {
    ...
    testGaussElimX (Integer(17), rhs, lhs, true);
    std::cout << "matrix 1, modulo 59" << std::endl;
  ...
  void testGaussElimEx ()
  {
    ...
    std::cout << "matrix 5, modulo 0" << std::endl;
