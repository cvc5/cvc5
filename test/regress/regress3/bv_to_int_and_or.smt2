...
; COMMAND-LINE: --solve-bv-as-int=bitwise --bvand-integer-granularity=1   --no-check-proofs
; COMMAND-LINE: --solve-bv-as-int=sum --bvand-integer-granularity=2   --no-check-proofs
; COMMAND-LINE: --solve-bv-as-int=bitwise --bvand-integer-granularity=2   --no-check-proofs
; EXPECT: unsat
(set-logic QF_BV)
