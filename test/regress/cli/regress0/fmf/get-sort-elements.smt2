...
; EXPECT: ((as |@(to_ nat_ term_)_1| (to_ nat_ term_)) (as |@(to_ nat_ term_)_0| (to_ nat_ term_)))
; EXPECT: (error "Parse Error: get-sort-elements.smt2:42.13: Symbol '@(to_ nat_ term_)_0' not declared as a variable")
; EXIT: 1
...
(get-sort-elements (to_ nat_ term_))
(get-sort-elements to_nat_term_)
