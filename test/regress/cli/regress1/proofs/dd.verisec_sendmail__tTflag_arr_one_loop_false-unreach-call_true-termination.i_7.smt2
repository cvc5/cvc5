...
(declare-fun m () Int)
(declare-fun a () Int)
(assert (forall ((v Int) (v_ Int)) (or (= 0 (mod v 0)) (= 0 (mod v_ 0)) (= 1 (mod v_ 0)) (= 1 (mod v 0)) (= 1 (mod 0 (+ 1 (mod v_ 0) (mod 0 (+ 1 a (mod m 0)))))) (= 1 (mod 0 (+ 1 (mod v 0) (mod 0 (+ 1 (mod v_ 0) (mod 0 (+ 1 a (mod m 0)))))))) (= 0 (mod 0 (+ 1 (mod v 0) (mod 0 (+ 1 (mod v_ 0) (mod 0 (+ 1 a (mod m 0)))))))))))
