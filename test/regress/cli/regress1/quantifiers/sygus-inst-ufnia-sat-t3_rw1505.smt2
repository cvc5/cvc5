...
(define-fun bit ((k Int) (l Int) (a Int)) Int (mod (div a (p2 l)) 2))
...
(define-fun intashr ((k Int) (a Int) (b Int) ) Int (ite (= (bit k (- k 1) a) 0) (intlshr k a b) (intnot k (intlshr k (intnot k a) b))))
