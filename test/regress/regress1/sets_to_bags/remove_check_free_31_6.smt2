...
(assert (! (forall ((?f FldLoc))
           (or (bag.count (ep$0 ?f sk_?X_30$0 null$0) sk_?X_30$0)
               (= null$0 (ep$0 ?f sk_?X_30$0 null$0))))
   :named entry-point3_10))

(assert (! (forall ((?f FldLoc))
           (or (bag.count (ep$0 ?f sk_?X_30$0 lst_1$0) sk_?X_30$0)
               (= lst_1$0 (ep$0 ?f sk_?X_30$0 lst_1$0))))
   :named entry-point3_11))

(assert (! (forall ((?f FldLoc))
           (or (bag.count (ep$0 ?f sk_?X_30$0 curr_3$0) sk_?X_30$0)
               (= curr_3$0 (ep$0 ?f sk_?X_30$0 curr_3$0))))
   :named entry-point3_12))

(assert (! (forall ((?f FldLoc))
           (or (bag.count (ep$0 ?f sk_?X_30$0 tmp_2$0) sk_?X_30$0)
...
(assert (! (forall ((?f FldLoc) (?y Loc))
           (or (Btwn$0 ?f null$0 (ep$0 ?f sk_?X_30$0 null$0) ?y)
               (not (Btwn$0 ?f null$0 ?y ?y)) (not (bag.count ?y sk_?X_30$0))))
   :named entry-point4_10))

(assert (! (forall ((?f FldLoc) (?y Loc))
           (or (Btwn$0 ?f lst_1$0 (ep$0 ?f sk_?X_30$0 lst_1$0) ?y)
               (not (Btwn$0 ?f lst_1$0 ?y ?y)) (not (bag.count ?y sk_?X_30$0))))
   :named entry-point4_11))

(assert (! (forall ((?f FldLoc) (?y Loc))
           (or (Btwn$0 ?f curr_3$0 (ep$0 ?f sk_?X_30$0 curr_3$0) ?y)
               (not (Btwn$0 ?f curr_3$0 ?y ?y)) (not (bag.count ?y sk_?X_30$0))))
   :named entry-point4_12))

(assert (! (forall ((?f FldLoc) (?y Loc))
           (or (Btwn$0 ?f tmp_2$0 (ep$0 ?f sk_?X_30$0 tmp_2$0) ?y)
               (not (Btwn$0 ?f tmp_2$0 ?y ?y)) (not (bag.count ?y sk_?X_30$0))))
   :named entry-point4_13))

(assert (! (forall ((?f FldLoc) (?y Loc))
           (or (not (Btwn$0 ?f null$0 ?y ?y)) (not (bag.count ?y sk_?X_30$0))
               (bag.count (ep$0 ?f sk_?X_30$0 null$0) sk_?X_30$0)))
   :named entry-point2_10))

(assert (! (forall ((?f FldLoc) (?y Loc))
           (or (not (Btwn$0 ?f lst_1$0 ?y ?y)) (not (bag.count ?y sk_?X_30$0))
               (bag.count (ep$0 ?f sk_?X_30$0 lst_1$0) sk_?X_30$0)))
   :named entry-point2_11))

(assert (! (forall ((?f FldLoc) (?y Loc))
           (or (not (Btwn$0 ?f curr_3$0 ?y ?y)) (not (bag.count ?y sk_?X_30$0))
               (bag.count (ep$0 ?f sk_?X_30$0 curr_3$0) sk_?X_30$0)))
   :named entry-point2_12))

(assert (! (forall ((?f FldLoc) (?y Loc))
           (or (not (Btwn$0 ?f tmp_2$0 ?y ?y)) (not (bag.count ?y sk_?X_30$0))
               (bag.count (ep$0 ?f sk_?X_30$0 tmp_2$0) sk_?X_30$0)))
...
(assert (! (forall ((l1 Loc))
           (or
               (and (Btwn$0 next$0 lst$0 l1 curr_2$0)
                    (bag.count l1 (lseg_domain$0 next$0 lst$0 curr_2$0))
                    (not (= l1 curr_2$0)))
               (and
                    (or (= l1 curr_2$0)
                        (not (Btwn$0 next$0 lst$0 l1 curr_2$0)))
                    (not (bag.count l1 (lseg_domain$0 next$0 lst$0 curr_2$0))))))
   :named lseg_footprint_20))

(assert (! (forall ((l1 Loc))
           (or
               (and (Btwn$0 next$0 curr_3$0 l1 null$0)
                    (bag.count l1 (lseg_domain$0 next$0 curr_3$0 null$0))
                    (not (= l1 null$0)))
               (and
                    (or (= l1 null$0)
                        (not (Btwn$0 next$0 curr_3$0 l1 null$0)))
                    (not (bag.count l1 (lseg_domain$0 next$0 curr_3$0 null$0))))))
   :named lseg_footprint_21))

(assert (! (not (bag.count tmp_2$0 FP_2$0)) :named check_free_31_6))

(assert (! (not (bag.count null$0 Alloc$0)) :named framecondition_of_remove_loop_18_4_15))
...
(assert (! (= sk_?X_30$0 (bag.union_disjoint sk_?X_31$0 sk_?X_32$0)) :named invariant_18_4_65))

(assert (! (= (as bag.empty SetLoc) (as bag.empty SetLoc)) :named invariant_18_4_66))

(assert (! (lseg_struct$0 sk_?X_28$0 next$0 curr_3$0 null$0)
   :named invariant_18_4_67))

(assert (! (= sk_?X_29$0 (bag.union_disjoint sk_?X_28$0 sk_?X_27$0)) :named invariant_18_4_68))

(assert (! (= sk_?X_28$0 (lseg_domain$0 next$0 curr_3$0 null$0))
   :named invariant_18_4_69))

(assert (! (= (as bag.empty SetLoc) (bag.inter_min sk_?X_27$0 sk_?X_28$0))
...
(assert (! (forall ((l1 Loc))
           (or
               (and (Btwn$0 next$0 lst_1$0 l1 curr_3$0)
                    (bag.count l1 (lseg_domain$0 next$0 lst_1$0 curr_3$0))
                    (not (= l1 curr_3$0)))
               (and
                    (or (= l1 curr_3$0)
                        (not (Btwn$0 next$0 lst_1$0 l1 curr_3$0)))
                    (not (bag.count l1 (lseg_domain$0 next$0 lst_1$0 curr_3$0))))))
   :named lseg_footprint_22))

(assert (! (forall ((l1 Loc))
           (or
               (and (Btwn$0 next$0 lst$0 l1 null$0)
                    (bag.count l1 (lseg_domain$0 next$0 lst$0 null$0))
                    (not (= l1 null$0)))
               (and (or (= l1 null$0) (not (Btwn$0 next$0 lst$0 l1 null$0)))
                    (not (bag.count l1 (lseg_domain$0 next$0 lst$0 null$0))))))
   :named lseg_footprint_23))

(assert (! (forall ((l1 Loc))
           (or
               (and (Btwn$0 next$0 curr_2$0 l1 null$0)
                    (bag.count l1 (lseg_domain$0 next$0 curr_2$0 null$0))
                    (not (= l1 null$0)))
               (and
                    (or (= l1 null$0)
                        (not (Btwn$0 next$0 curr_2$0 l1 null$0)))
                    (not (bag.count l1 (lseg_domain$0 next$0 curr_2$0 null$0))))))
   :named lseg_footprint_24))

(assert (! (not (bag.count null$0 Alloc$0)) :named initial_footprint_of_remove_10_11_11))
...
(assert (! (= (as bag.empty SetLoc) (bag.inter_min sk_?X_32$0 sk_?X_31$0))
...
(assert (! (= (as bag.empty SetLoc) (as bag.empty SetLoc)) :named invariant_18_4_80))

(assert (! (= Alloc$0 (bag.union_disjoint FP_2$0 Alloc$0))
...
(assert (! (= FP_Caller_1$0 (bag.difference_remove FP_Caller$0 FP$0)) :named assign_13_2_5))
