...
(define-fun bag.member ((e Loc) (B (Bag Loc))) Bool (>= (bag.count e B) 1))
...
(assert
  (! (Btwn$0 next$0 null$0 (read$0 next$0 null$0) (read$0 next$0 null$0))
     :named btwn_step_8))

(assert
  (! (Btwn$0 next$0 tmp_2$0 (read$0 next$0 tmp_2$0) (read$0 next$0 tmp_2$0))
     :named btwn_step_9))

(assert
  (! (Btwn$0 next$0 curr_3$0 (read$0 next$0 curr_3$0) (read$0 next$0 curr_3$0))
     :named btwn_step_10))

(assert
  (!
    (forall ((?f FldLoc))
            (or (bag.member (ep$0 ?f sk_?X_30$0 null$0) sk_?X_30$0)
...
(assert
  (!
    (forall ((?f FldLoc))
            (or (bag.member (ep$0 ?f sk_?X_30$0 lst_1$0) sk_?X_30$0)
...
(assert
  (!
    (forall ((?f FldLoc))
            (or (bag.member (ep$0 ?f sk_?X_30$0 curr_3$0) sk_?X_30$0)
...
(assert
  (!
    (forall ((?f FldLoc))
            (or (bag.member (ep$0 ?f sk_?X_30$0 tmp_2$0) sk_?X_30$0)
...
(assert
  (!
    (forall ((?f FldLoc) (?y Loc))
            (or (Btwn$0 ?f null$0 (ep$0 ?f sk_?X_30$0 null$0) ?y)
                (not (Btwn$0 ?f null$0 ?y ?y)) (not (bag.member ?y sk_?X_30$0))))
  ...
  (!
    (forall ((?f FldLoc) (?y Loc))
            (or (Btwn$0 ?f lst_1$0 (ep$0 ?f sk_?X_30$0 lst_1$0) ?y)
                (not (Btwn$0 ?f lst_1$0 ?y ?y)) (not (bag.member ?y sk_?X_30$0))))
  ...
  (!
    (forall ((?f FldLoc) (?y Loc))
            (or (Btwn$0 ?f curr_3$0 (ep$0 ?f sk_?X_30$0 curr_3$0) ?y)
                (not (Btwn$0 ?f curr_3$0 ?y ?y)) (not (bag.member ?y sk_?X_30$0))))
  ...
  (!
    (forall ((?f FldLoc) (?y Loc))
            (or (Btwn$0 ?f tmp_2$0 (ep$0 ?f sk_?X_30$0 tmp_2$0) ?y)
                (not (Btwn$0 ?f tmp_2$0 ?y ?y)) (not (bag.member ?y sk_?X_30$0))))
    :named entry-point4_13))

(assert
  (!
    (forall ((?f FldLoc) (?y Loc))
            (or (not (Btwn$0 ?f null$0 ?y ?y)) (not (bag.member ?y sk_?X_30$0))
                (bag.member (ep$0 ?f sk_?X_30$0 null$0) sk_?X_30$0)))
    :named entry-point2_10))

(assert
  (!
    (forall ((?f FldLoc) (?y Loc))
            (or (not (Btwn$0 ?f lst_1$0 ?y ?y)) (not (bag.member ?y sk_?X_30$0))
                (bag.member (ep$0 ?f sk_?X_30$0 lst_1$0) sk_?X_30$0)))
    :named entry-point2_11))

(assert
  (!
    (forall ((?f FldLoc) (?y Loc))
            (or (not (Btwn$0 ?f curr_3$0 ?y ?y)) (not (bag.member ?y sk_?X_30$0))
                (bag.member (ep$0 ?f sk_?X_30$0 curr_3$0) sk_?X_30$0)))
    :named entry-point2_12))

(assert
  (!
    (forall ((?f FldLoc) (?y Loc))
            (or (not (Btwn$0 ?f tmp_2$0 ?y ?y)) (not (bag.member ?y sk_?X_30$0))
                (bag.member (ep$0 ?f sk_?X_30$0 tmp_2$0) sk_?X_30$0)))
    ...
    (forall ((l1 Loc))
            (or
             (and (Btwn$0 next$0 lst$0 l1 curr_2$0)
                  (bag.member l1 (lseg_domain$0 next$0 lst$0 curr_2$0))
                  (not (= l1 curr_2$0)))
             (and
              (or (= l1 curr_2$0)
                  (not (Btwn$0 next$0 lst$0 l1 curr_2$0)))
              (not (bag.member l1 (lseg_domain$0 next$0 lst$0 curr_2$0))))))
    ...
    (forall ((l1 Loc))
            (or
             (and (Btwn$0 next$0 curr_3$0 l1 null$0)
                  (bag.member l1 (lseg_domain$0 next$0 curr_3$0 null$0))
                  (not (= l1 null$0)))
             (and
              (or (= l1 null$0)
                  (not (Btwn$0 next$0 curr_3$0 l1 null$0)))
              (not (bag.member l1 (lseg_domain$0 next$0 curr_3$0 null$0))))))
    :named lseg_footprint_21))

(assert (! (not (bag.member tmp_2$0 FP_2$0)) :named check_free_31_6))

(assert
  (! (not (bag.member null$0 Alloc$0)) :named framecondition_of_remove_loop_18_4_15))

(assert (! (not (= lst$0 null$0)) :named if_else_13_6_4))

(assert
  (! (= FP_Caller$0 (bag.union_disjoint FP$0 FP_Caller$0))
     :named precondition_of_remove_10_11_20))

(assert (! (= sk_?X_33$0 FP$0) :named precondition_of_remove_10_11_21))

(assert
  (! (lseg_struct$0 sk_?X_32$0 next$0 lst$0 curr_2$0) :named invariant_18_4_62))

(assert (! (= FP$0 (bag.union_disjoint FP_1$0 FP$0)) :named invariant_18_4_63))

(assert
  (! (= sk_?X_31$0 (lseg_domain$0 next$0 curr_2$0 null$0))
     :named invariant_18_4_64))

(assert
  (! (= sk_?X_30$0 (bag.union_disjoint sk_?X_31$0 sk_?X_32$0)) :named invariant_18_4_65))

(assert
  (! (= (as bag.empty SetLoc) (as bag.empty SetLoc)) :named invariant_18_4_66))

(assert
  (! (lseg_struct$0 sk_?X_28$0 next$0 curr_3$0 null$0)
     :named invariant_18_4_67))

(assert
  (! (= sk_?X_29$0 (bag.union_disjoint sk_?X_28$0 sk_?X_27$0)) :named invariant_18_4_68))

(assert
  (! (= sk_?X_28$0 (lseg_domain$0 next$0 curr_3$0 null$0))
     :named invariant_18_4_69))

(assert
  (! (= (as bag.empty SetLoc) (bag.inter_min sk_?X_27$0 sk_?X_28$0))
     :named invariant_18_4_70))

(assert
  (! (= Alloc$0 (bag.union_disjoint FP_Caller$0 Alloc$0))
...
(assert
  (!
    (= FP_2$0
       (bag.union_disjoint (bag.difference_remove FP$0 FP_1$0)
                           (bag.union_disjoint (bag.inter_min Alloc$0 FP_1$0) (bag.difference_remove Alloc$0 Alloc$0))))
    :named framecondition_of_remove_loop_18_4_17))

(assert
  (!
    (or (Btwn$0 next$0 lst$0 curr_2$0 curr_2$0)
        (not (lseg_struct$0 sk_?X_32$0 next$0 lst$0 curr_2$0)))
    :named unnamed_23))

(assert
  (!
    (or (Btwn$0 next$0 curr_3$0 null$0 null$0)
        (not (lseg_struct$0 sk_?X_28$0 next$0 curr_3$0 null$0)))
    :named unnamed_24))

(assert
  (! (or (= (read$0 next$0 curr_3$0) null$0) (not nondet_2$0))
     :named unnamed_25))
    ...
    (forall ((l1 Loc))
            (or
             (and (Btwn$0 next$0 lst_1$0 l1 curr_3$0)
                  (bag.member l1 (lseg_domain$0 next$0 lst_1$0 curr_3$0))
                  (not (= l1 curr_3$0)))
             (and
              (or (= l1 curr_3$0)
                  (not (Btwn$0 next$0 lst_1$0 l1 curr_3$0)))
              (not (bag.member l1 (lseg_domain$0 next$0 lst_1$0 curr_3$0))))))
    ...
    (forall ((l1 Loc))
            (or
             (and (Btwn$0 next$0 lst$0 l1 null$0)
                  (bag.member l1 (lseg_domain$0 next$0 lst$0 null$0))
                  (not (= l1 null$0)))
             (and (or (= l1 null$0) (not (Btwn$0 next$0 lst$0 l1 null$0)))
                  (not (bag.member l1 (lseg_domain$0 next$0 lst$0 null$0))))))
    ...
    (forall ((l1 Loc))
            (or
             (and (Btwn$0 next$0 curr_2$0 l1 null$0)
                  (bag.member l1 (lseg_domain$0 next$0 curr_2$0 null$0))
                  (not (= l1 null$0)))
             (and
              (or (= l1 null$0)
                  (not (Btwn$0 next$0 curr_2$0 l1 null$0)))
              (not (bag.member l1 (lseg_domain$0 next$0 curr_2$0 null$0))))))
    :named lseg_footprint_24))

(assert
  (! (not (bag.member null$0 Alloc$0)) :named initial_footprint_of_remove_10_11_11))

(assert (! (not (= tmp_2$0 null$0)) :named if_else_28_8_2))

(assert
  (! (lseg_struct$0 sk_?X_33$0 next$0 lst$0 null$0)
     :named precondition_of_remove_10_11_22))

(assert
  (! (= sk_?X_33$0 (lseg_domain$0 next$0 lst$0 null$0))
     :named precondition_of_remove_10_11_23))

(assert (! (not (= curr_2$0 null$0)) :named invariant_18_4_71))

(assert
  (! (lseg_struct$0 sk_?X_31$0 next$0 curr_2$0 null$0)
     :named invariant_18_4_72))

(assert
  (! (= sk_?X_32$0 (lseg_domain$0 next$0 lst$0 curr_2$0))
     :named invariant_18_4_73))

(assert (! (= sk_?X_30$0 FP_1$0) :named invariant_18_4_74))

(assert
  (! (= (as bag.empty SetLoc) (bag.inter_min sk_?X_32$0 sk_?X_31$0))
     :named invariant_18_4_75))

(assert (! (not (= curr_3$0 null$0)) :named invariant_18_4_76))

(assert
  (! (lseg_struct$0 sk_?X_27$0 next$0 lst_1$0 curr_3$0)
...
(assert
  (! (= sk_?X_27$0 (lseg_domain$0 next$0 lst_1$0 curr_3$0))
     :named invariant_18_4_79))

(assert
  (! (= (as bag.empty SetLoc) (as bag.empty SetLoc)) :named invariant_18_4_80))

(assert
  (! (= Alloc$0 (bag.union_disjoint FP_2$0 Alloc$0))
...
(assert
  (! (= FP_Caller_1$0 (bag.difference_remove FP_Caller$0 FP$0)) :named assign_13_2_5))

(assert
  (!
    (or (Btwn$0 next$0 lst_1$0 curr_3$0 curr_3$0)
        (not (lseg_struct$0 sk_?X_27$0 next$0 lst_1$0 curr_3$0)))
    :named unnamed_26))

(assert
  (!
    (or (Btwn$0 next$0 lst$0 null$0 null$0)
        (not (lseg_struct$0 sk_?X_33$0 next$0 lst$0 null$0)))
    :named unnamed_27))

(assert
  (!
    (or (Btwn$0 next$0 curr_2$0 null$0 null$0)
        (not (lseg_struct$0 sk_?X_31$0 next$0 curr_2$0 null$0)))
    :named unnamed_28))

(assert
  (!
    (forall ((?u Loc) (?v Loc) (?z Loc))
            (and
             (or
...
(assert
  (! (forall ((?x Loc) (?y Loc)) (or (not (Btwn$0 next$0 ?x ?y ?x)) (= ?x ?y)))
     :named btwn_sndw_5))
...
(assert
  (!
    (forall ((?u Loc) (?x Loc) (?y Loc) (?z Loc))
