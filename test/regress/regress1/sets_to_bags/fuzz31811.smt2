...
(declare-fun f1 ( (Bag Element) (Bag Element)) (Bag Element))
(declare-fun p0 ( Int Int Int) Bool)
(declare-fun p1 ( (Bag Element)) Bool)
(declare-fun v0 () Int)
(declare-fun v1 () (Bag Element))
(declare-fun v2 () (Bag Element))
(declare-fun v3 () (Bag Element))
(declare-fun v4 () (Bag Element))
(assert (let ((e5 2))
(let ((e6 (+ v0 v0)))
(let ((e7 (* e6 e5)))
(let ((e8 (* e6 (- e5))))
...
(let ((e10 (f0 v0 e8 e8)))
(let ((e11 (ite (p1 v1) (bag 1 1) (bag 0 1))))
(let ((e12 (bag.union_disjoint v3 v3)))
(let ((e13 (bag.inter_min v3 v1)))
(let ((e14 (ite (p1 v3) (bag 1 1) (bag 0 1))))
(let ((e15 (bag.inter_min v2 e14)))
(let ((e16 (ite (p1 e11) (bag 1 1) (bag 0 1))))
(let ((e17 (ite (p1 v4) (bag 1 1) (bag 0 1))))
(let ((e18 (bag.union_disjoint e15 v2)))
(let ((e19 (ite (p1 e16) (bag 1 1) (bag 0 1))))
(let ((e20 (bag.inter_min e18 v3)))
(let ((e21 (bag.difference_remove v4 e12)))
(let ((e22 (bag.union_disjoint v3 v2)))
(let ((e23 (bag.difference_remove e12 v4)))
(let ((e24 (bag.difference_remove v3 e16)))
(let ((e25 (bag.inter_min e19 e20)))
(let ((e26 (ite (p1 e15) (bag 1 1) (bag 0 1))))
(let ((e27 (bag.difference_remove e17 e15)))
(let ((e28 (f1 e23 e12)))
(let ((e29 (>= (bag.count e10 e16) 1)))
(let ((e30 (>= (bag.count e10 v1)  1)))
(let ((e31 (>= (bag.count e7 e19)  1)))
(let ((e32 (f1 e12 e12)))
(let ((e33 (f1 e16 e25)))
(let ((e34 (f1 v1 e27)))
(let ((e35 (f1 e19 e19)))
