...
(declare-fun f1 ( (Bag Element) (Bag Element) (Bag Element)) (Bag Element))
...
(let ((e13 (bag.union_disjoint v3 v4)))
(let ((e14 (bag.difference_remove v2 v2)))
(let ((e15 (f1 v1 v4 v1)))
(let ((e16 (f1 e14 v1 v4)))
(let ((e17 (bag.inter_min e16 e15)))
(let ((e18 (f1 v4 e15 v2)))
(let ((e19 (ite (p1 e13) (bag 1 1) (bag 0 1))))
(let ((e20 (>= (bag.count v0 e17) 1)))
(let ((e21 (>= (bag.count e7 e16) 1)))
(let ((e22 (>= (bag.count e10 e16) 1)))
(let ((e23 (>= (bag.count e8 e17) 1)))
(let ((e24 (>= (bag.count e9 e14) 1)))
(let ((e25 (>= (bag.count e8 e16) 1)))
(let ((e26 (>= (bag.count v0 e13) 1)))
(let ((e27 (>= (bag.count e12 v4) 1)))
(let ((e28 (>= (bag.count e8 e14) 1)))
(let ((e29 (>= (bag.count e8 v1) 1)))
(let ((e30 (>= (bag.count e10 e13) 1)))
(let ((e31 (>= (bag.count e7 e13) 1)))
