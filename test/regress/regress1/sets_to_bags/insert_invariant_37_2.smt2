...
(assert (! (= sk_?X_1$0 (bag.union_disjoint sk_?X_3$0 sk_?X_4$0)) :named invariant_37_2_4))

(assert (! (= FP_Caller$0 (bag.union_disjoint FP$0 FP_Caller$0))
   :named precondition_of_insert_27_11))

(assert (! (= sk_?X$0 FP$0) :named precondition_of_insert_27_11_1))

(assert (! (= Alloc$0 (bag.union_disjoint FP_Caller$0 Alloc$0))
...
(assert (! (= c2_2$0 (as bag.empty SetInt)) :named assign_35_2))

(assert (! (= FP_Caller_1$0 (bag.difference_remove FP_Caller$0 FP$0)) :named assign_29_0))
