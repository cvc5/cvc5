...
(declare-sort Loc 0)
(define-sort BagLoc () (Bag Loc))
(define-sort BagInt () (Bag Int))
(declare-sort FldLoc 0)
(declare-sort FldInt 0)
(declare-fun null$0 () Loc)
(declare-fun read$0 (FldLoc Loc) Loc)
(declare-fun Btwn$0 (FldLoc Loc Loc Loc) Bool)
(declare-fun Alloc$0 () BagLoc)
(declare-fun Alloc_2$0 () BagLoc)
(declare-fun FP$0 () BagLoc)
(declare-fun FP_3$0 () BagLoc)
(declare-fun FP_Caller$0 () BagLoc)
(declare-fun FP_Caller_2$0 () BagLoc)
(declare-fun cp$0 () Loc)
(declare-fun cp_1$0 () Loc)
(declare-fun curr$0 () Loc)
(declare-fun lseg_domain$0 (FldLoc Loc Loc) BagLoc)
(declare-fun lseg_struct$0 (BagLoc FldLoc Loc Loc) Bool)
(declare-fun next$0 () FldLoc)
(declare-fun old_cp_2$0 () Loc)
(declare-fun sk_?X_36$0 () BagLoc)
(declare-fun sk_?X_37$0 () BagLoc)
(declare-fun sk_?X_38$0 () BagLoc)
...
(assert (! (forall ((l1 Loc))
           (or
               (and (Btwn$0 next$0 curr$0 l1 null$0)
                    (>= (bag.count l1 (lseg_domain$0 next$0 curr$0 null$0)) 1)
                    (not (= l1 null$0)))
               (and (or (= l1 null$0) (not (Btwn$0 next$0 curr$0 l1 null$0)))
                    (not (>= (bag.count l1 (lseg_domain$0 next$0 curr$0 null$0)) 1)))))
   :named lseg_footprint_14))

(assert (! (not (>= (bag.count tmp_1$0 Alloc$0) 1)) :named new_42_10))

(assert (! (not (>= (bag.count null$0 Alloc$0) 1))
...
(assert (! (= (as bag.empty BagLoc) (bag.inter_min sk_?X_38$0 sk_?X_37$0))
   :named precondition_of_rec_copy_loop_34_11_19))

(assert (! (= old_cp_2$0 cp$0) :named assign_41_4))

(assert (! (= FP_Caller_2$0 (bag.difference_remove FP_Caller$0 FP$0)) :named assign_37_2_2))

(assert (! (= Alloc_2$0 (bag.union_disjoint Alloc$0 (bag tmp_1$0 1))) :named assign_42_10))
...
(assert (! (forall ((l1 Loc))
           (or
               (and (Btwn$0 next$0 cp$0 l1 null$0)
                    (>= (bag.count l1 (lseg_domain$0 next$0 cp$0 null$0)) 1)
                    (not (= l1 null$0)))
               (and (or (= l1 null$0) (not (Btwn$0 next$0 cp$0 l1 null$0)))
                    (not (>= (bag.count l1 (lseg_domain$0 next$0 cp$0 null$0)) 1)))))
   :named lseg_footprint_15))

(assert (! (not (>= (bag.count cp_1$0 FP_3$0) 1)) :named check_heap_access_43_4))
...
(assert (! (= sk_?X_36$0 (bag.union_disjoint sk_?X_37$0 sk_?X_38$0))
...
(assert (! (= FP_3$0 (bag.union_disjoint FP$0 (bag tmp_1$0 1))) :named assign_42_10_1))
